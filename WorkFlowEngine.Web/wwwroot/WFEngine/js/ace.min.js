(function () {
	...
	if (e || "undefined" == typeof window || (e = window), "undefined" == typeof requirejs) {
		var o = function (e, t, i) {
			"string" == typeof e ? (2 == arguments.length && (i = t), o.modules[e] || (o.payloads[e] = i, o.modules[e] = null)) : o.original ? o.original.apply(this, arguments) : (console.error("dropping module because define wasn't a string."), console.trace())
		};
		o.modules = {}, o.payloads = {};
		...
		function r(e, t, i) {
			if ("string" == typeof t) {
				...
				for (var s = [], o = 0, r = t.length; o < r; ++o) {
					var a = h(e, t[o]);
					if (null == a && l.original) return;
					s.push(a)
				}
				return i && i.apply(null, s) || !0
			}
		}
		var t, i, l = function (e, t) {
			var i = r("", e, t);
			...
			h = function (e, i) {
				...
				var t = o.modules[i];
				if (!t) {
					if ("function" == typeof (t = o.payloads[i])) {
						var n = {},
							s = {
								id: i,
								uri: "",
						...
						n = t(function (e, t) {
							return r(i, e, t)
						}, n, s) || s.exports, o.modules[i] = n, delete o.payloads[i]
					}
					t = o.modules[i] = n || t
				}
				return t
			};
		i = e, (t = "") && (e[t] || (e[t] = {}), i = e[t]), i.define && i.define.packaged || (o.original = i.define, i.define = o, i.define.packaged = !0), i.require && i.require.packaged || (l.original = i.require, i.require = l, i.require.packaged = !0)
	}
	...
	var n, r = {
		...
		a = void 0 === r.exec.call(/()??/, "")[1],
		l = (n = /^/g, r.test.call(n, ""), !n.lastIndex);
	l && a || (RegExp.prototype.exec = function (e) {
		var t, i, n, s = r.exec.apply(this, arguments);
		if ("string" == typeof e && s) {
			if (!a && 1 < s.length && -1 < function (e, t, i) {
				if (Array.prototype.indexOf) return e.indexOf(t, i);
				for (var n = i || 0; n < e.length; n++)
					if (e[n] === t) return n;
				return -1
			}(s, "") && (i = RegExp(this.source, r.replace.call(((n = this).global ? "g" : "") + (n.ignoreCase ? "i" : "") + (n.multiline ? "m" : "") + (n.extended ? "x" : "") + (n.sticky ? "y" : ""), "g", "")), r.replace.call(e.slice(s.index), i, function () {
				for (var e = 1; e < arguments.length - 2; e++) void 0 === arguments[e] && (s[e] = void 0)
			})), this._xregexp && this._xregexp.captureNames)
				for (var o = 1; o < s.length; o++)(t = this._xregexp.captureNames[o - 1]) && (s[t] = s[o]);
			!l && this.global && !s[0].length && this.lastIndex > s.index && this.lastIndex--
		}
		return s
	}, l || (RegExp.prototype.test = function (e) {
	...
	function s(e) {
		return (e = +e) != e ? e = 0 : 0 !== e && e !== 1 / 0 && e !== -1 / 0 && (e = (0 < e || -1) * Math.floor(Math.abs(e))), e
	}
		...
		var n = p.call(arguments, 1),
			s = function () {
				if (this instanceof s) {
					var e = i.apply(this, n.concat(p.call(arguments)));
					return Object(e) === e ? e : this
				}
				return i.apply(t, n.concat(p.call(arguments)))
			};
		return i.prototype && (o.prototype = i.prototype, s.prototype = new o, o.prototype = null), s
	});
	var r, a, l, h, c, u, d, g = Function.prototype.call,
		f = Array.prototype,
		m = Object.prototype,
		p = f.slice,
		v = g.bind(m.toString),
		w = g.bind(m.hasOwnProperty);
	if ((c = w(m, "__defineGetter__")) && (r = g.bind(m.__defineGetter__), a = g.bind(m.__defineSetter__), l = g.bind(m.__lookupGetter__), h = g.bind(m.__lookupSetter__)), 2 != [1, 2].splice(0).length)
		if ((d = []).splice.apply(d, b(20)), d.splice.apply(d, b(26)), u = d.length, d.splice(5, 0, "XXX"), d.length, u + 1 != d.length) Array.prototype.splice = function (e, t) {
			var i = this.length;
			0 < e ? i < e && (e = i) : null == e ? e = 0 : e < 0 && (e = Math.max(i + e, 0)), e + t < i || (t = i - e);
			var n = this.slice(e, e + t),
				s = p.call(arguments, 2),
				o = s.length;
			...
			Array.prototype.splice = function (e, t) {
				return arguments.length ? $.apply(this, [void 0 === e ? 0 : e, void 0 === t ? this.length - e : t].concat(p.call(arguments, 2))) : []
			}
		}
	function b(e) {
		var t = new Array(e + 2);
	...
	if (Array.prototype.forEach || (Array.prototype.forEach = function (e) {
		var t = F(this),
			i = C && "[object String]" == v(this) ? this.split("") : t,
			n = arguments[1],
			s = -1,
			o = i.length >>> 0;
		if ("[object Function]" != v(e)) throw new TypeError;
		...
		var t = F(this),
			...
			s = Array(n),
			o = arguments[1];
		if ("[object Function]" != v(e)) throw new TypeError(e + " is not a function");
		for (var r = 0; r < n; r++) r in i && (s[r] = e.call(o, i[r], r, t));
		return s
	}), Array.prototype.filter || (Array.prototype.filter = function (e) {
		var t, i = F(this),
			n = C && "[object String]" == v(this) ? this.split("") : i,
			s = n.length >>> 0,
			o = [],
			r = arguments[1];
		if ("[object Function]" != v(e)) throw new TypeError(e + " is not a function");
		...
		var s, o = 0;
		if (2 <= arguments.length) s = arguments[1];
		else
			for (; ;) {
				if (o in i) {
					s = i[o++];
		...
		for (; o in this && (s = e.call(void 0, s, i[o], o, t)), o--;);
		return s
	}), Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2) || (Array.prototype.indexOf = function (e) {
		var t = C && "[object String]" == v(this) ? this.split("") : F(this),
			i = t.length >>> 0;
		if (!i) return -1;
		var n = 0;
		for (1 < arguments.length && (n = s(arguments[1])), n = 0 <= n ? n : Math.max(0, i + n); n < i; n++)
		...
		if (!i) return -1;
		var n = i - 1;
		for (1 < arguments.length && (n = Math.min(n, s(arguments[1]))), n = 0 <= n ? n : i - Math.abs(n); 0 <= n; n--)
			if (n in t && e === t[n]) return n;
		return -1
	}), Object.getPrototypeOf || (Object.getPrototypeOf = function (e) {
		return e.__proto__ || (e.constructor ? e.constructor.prototype : m)
	...
	}), Object.create || (y = null === Object.prototype.__proto__ ? function () {
		return {
			__proto__: null
		}
	} : function () {
	...
	if (Object.defineProperty) {
		var x = n({}),
			A = "undefined" == typeof document || n(document.createElement("div"));
		if (!x || !A) var k = Object.defineProperty
	}
	...
	if (Object.preventExtensions || (Object.preventExtensions = function (e) {
		...
		Object.keys = function (e) {
			...
			var t = [];
			for (var i in e) w(e, i) && t.push(i);
			if (L)
				for (var n = 0, s = E; n < s; n++) {
					var o = R[n];
					w(e, o) && t.push(o)
				}
			return t
	...
	if (!String.prototype.trim) {
		_ = "[" + _ + "]";
		var T = new RegExp("^" + _ + _ + "*"),
			O = new RegExp(_ + _ + "*$");
		String.prototype.trim = function () {
			return String(this).replace(T, "").replace(O, "")
		}
	}
	var F = function (e) {
	...
	if (a.buildDom = function e(t, i, n) {
		...
		if (t && a.hasCssString(t, n)) return null;
		t && (e += "\n/*# sourceURL=ace/css/" + t + " */");
		var o = a.createElement("style");
		o.appendChild(s.createTextNode(e)), t && (o.id = t), n == s && (n = a.getDocumentHead(s)), n.insertBefore(o, n.firstChild)
		...
		n.overflow = "scroll";
		var r = t.offsetWidth;
		return o == r && (r = i.clientWidth), s.removeChild(i), o - r
	}, "undefined" == typeof document && (a.importCssString = function () { }), a.computedStyle = function (e, t) {
		return window.getComputedStyle(e, "") || {}
	}, a.setStyle = function (e, t, i) {
		e[t] !== i && (e[t] = i)
	}, a.HAS_CSS_ANIMATION = !1, a.HAS_CSS_TRANSFORMS = !1, a.HI_DPI = !i.isWin || "undefined" != typeof window && 1.5 <= window.devicePixelRatio, "undefined" != typeof document) {
		var n = document.createElement("div");
		a.HI_DPI && void 0 !== n.style.transform && (a.HAS_CSS_TRANSFORMS = !0), i.isEdge || void 0 === n.style.animationName || (a.HAS_CSS_ANIMATION = !0), n = null
	}
	...
	function r(e, t, i) {
		...
		if ((i in l.MODIFIER_KEYS && (i = -1), !n && 13 === i) && (3 === (s = "location" in t ? t.location : t.keyLocation) && (e(t, n, -i), t.defaultPrevented))) return;
		if (d.isChromeOS && 8 & n) {
			if (e(t, n, i), t.defaultPrevented) return;
			n &= -9
		}
		return !!(n || i in l.FUNCTION_KEYS || i in l.PRINTABLE_KEYS) && e(t, n, i)
	}
	...
	var g = u.addListener = function (e, t, i, n) {
		e.addEventListener(t, i, s()), n && n.$toDestroy.push(new o(e, t, i))
	},
		f = u.removeListener = function (e, t, i) {
			e.removeEventListener(t, i, s())
		};
	u.stopEvent = function (e) {
		return u.stopPropagation(e), u.preventDefault(e), !1
		...
		function n(e) {
			t && t(e), i && i(e), f(document, "mousemove", t), f(document, "mouseup", n), f(document, "dragstart", n)
		}
		return g(document, "mousemove", t), g(document, "mouseup", n), g(document, "dragstart", n), n
		...
		function o(e) {
			if (0 !== u.getButton(e) ? h = 0 : 1 < e.detail ? 4 < ++h && (h = 1) : h = 1, d.isIE) {
				var t = 5 < Math.abs(e.clientX - r) || 5 < Math.abs(e.clientY - a);
				l && !t || (h = 1), l && clearTimeout(l), l = setTimeout(function () {
					l = null
				}, i[h - 1] || 600), 1 == h && (r = e.clientX, a = e.clientY)
			}
			if (e._clicks = h, n[s]("mousedown", e), 4 < h) h = 0;
			else if (1 < h) return n[s](c[h], e)
		}
		var r, a, l, h = 0,
			c = {
				2: "dblclick",
	...
	if (u.getModifierString = function (e) {
		...
		if (d.isOldGecko || d.isOpera && !("KeyboardEvent" in window)) {
			...
			g(e, "keydown", function (e) {
				...
				s && (e.ctrlKey || e.altKey || e.shiftKey || e.metaKey) && (u.stopEvent(e), s = null)
			}, t), g(e, "keyup", function (e) {
				h[e.keyCode] = null
			}, t), h || (a(), g(window, "focus", a))
		}
	}, "object" == typeof window && window.postMessage && !d.isOldIE) {
		var p = 1;
		u.nextTick = function (t, i) {
			i = i || window;
			var n = "zero-timeout-message-" + p++,
				s = function (e) {
					e.data == n && (u.stopPropagation(e), f(i, "message", s), t())
				};
			g(i, "message", s), i.postMessage(n, "*")
		}
	}
	u.$idleBlocked = !1, u.onIdle = function (t, e) {
		return setTimeout(function e() {
			u.$idleBlocked ? setTimeout(e, 100) : t()
		}, e)
	}, u.$idleBlockId = null, u.blockIdle = function (e) {
		u.$idleBlockId && clearTimeout(u.$idleBlockId), u.$idleBlocked = !0, u.$idleBlockId = setTimeout(function () {
			u.$idleBlocked = !1
		}, e || 100)
	}, u.nextFrame = "object" == typeof window && (window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame), u.nextFrame ? u.nextFrame = u.nextFrame.bind(window) : u.nextFrame = function (e) {
		setTimeout(e, 17)
	}
	...
	t.stringTrimLeft = function (e) {
		...
		var i = null,
			n = function (e) {
				return n.cancel(), i = setTimeout(t, e || 0), n
			};
		return (n.schedule = n).call = function () {
			return this.cancel(), e(), n
		}, n.cancel = function () {
			return clearTimeout(i), i = null, n
	...
	var D = e("../lib/event"),
		...
		q = j ? /\s/ : /\n/,
		X = B.isMobile;
	t.TextInput = function (e, u) {
		function i() {
			t = !0, d.blur(), d.focus(), t = !1
		}

		function l() {
			clearTimeout(_), _ = setTimeout(function () {
				c && (d.style.cssText = c, c = ""), u.renderer.$isMousePressed = !1, u.renderer.$keepTextAreaAtCursor && u.renderer.$moveTextAreaToCursor()
			}, 0)
		}
		var d = P.createElement("textarea");
		...
		var m = !1,
			...
			$ = 0;
		try {
			var b = document.activeElement === d
		} catch (e) { }
		D.addListener(d, "blur", function (e) {
			t || (u.onBlur(e), b = !1)
		}, u), D.addListener(d, "focus", function (e) {
			if (!t) {
				if (b = !0, B.isEdge) try {
					if (!document.hasFocus()) return
				} catch (e) { }
				u.onFocus(e), B.isEdge ? setTimeout(y) : y()
			}
		}, u), this.$focusScroll = !1, this.focus = function () {
			if (c || U || "browser" == this.$focusScroll) return d.focus({
				preventScroll: !0
			});
			var e = d.style.top;
			d.style.position = "fixed", d.style.top = "0px";
			try {
				var t = 0 != d.getBoundingClientRect().top
			} catch (e) {
				return
			}
			var i = [];
			if (t)
				for (var n = d.parentElement; n && 1 == n.nodeType;) i.push(n), n.setAttribute("ace_nocontext", !0), n = !n.parentElement && n.getRootNode ? n.getRootNode().host : n.parentElement;
			d.focus({
				preventScroll: !0
			...
			return b
		}, u.on("beforeEndOperation", function () {
			var e = u.curOp,
				t = e && e.command && e.command.name;
			if ("insertstring" != t) {
				var i = t && (e.docChanged || e.selectionChanged);
				h && i && (p = d.value = "", R()), y()
			}
		});
		var y = j ? function (e) {
			if (b && (!r || e) && !f) {
				var t = "\n ab" + (e = e || "") + "cde fg\n";
				t != d.value && (d.value = p = t);
				var i = 4 + (e.length || (u.selection.isEmpty() ? 0 : 1));
				4 == v && w == i || d.setSelectionRange(4, i), v = 4, w = i
			}
		} : function () {
			if (!h && !f && (b || A)) {
				h = !0;
				...
				if (u.session) {
					var n = u.selection,
						s = n.getRange(),
						o = n.cursor.row;
					if (e = s.start.column, t = s.end.column, i = u.session.getLine(o), s.start.row != o) {
						var r = u.session.getLine(o - 1);
						e = s.start.row < o - 1 ? 0 : e, t += r.length + 1, i = r + "\n" + i
					} else if (s.end.row != o) {
						var a = u.session.getLine(o + 1);
						t = s.end.row > o + 1 ? a.length : t, t += i.length + 1, i = i + "\n" + a
					} else X && 0 < o && (i = "\n" + i, t += 1, e += 1);
					400 < i.length && (e < 400 && t < 400 ? i = i.slice(0, 400) : (i = "\n", e = 0, t = 1))
				}
				var l = i + "\n\n";
				if (l != p && (d.value = p = l, v = w = l.length), A && (v = d.selectionStart, w = d.selectionEnd), w != t || v != e || d.selectionEnd != w) try {
					d.setSelectionRange(e, t), v = e, w = t
				} catch (e) { }
				h = !1
			}
		};
		this.resetSelection = y, b && u.onFocus();
		var n = null;
		...
		function s(e, t) {
			if (A = A && !1, g) return y(), e && u.onPaste(e), g = !1, "";
			for (var i = d.selectionStart, n = d.selectionEnd, s = v, o = p.length - w, r = e, a = e.length - i, l = e.length - n, h = 0; 0 < s && p[h] == e[h];) h++, s--;
			for (r = r.slice(h), h = 1; 0 < o && p.length - h > v - 1 && p[p.length - h] == e[e.length - h];) h++, o--;
			a -= h - 1, l -= h - 1;
			var c = r.length - h + 1;
			return c < 0 && (s = -c, c = 0), r = r.slice(0, c), t || r || a || s || o || l ? (f = !0, r && !s && !o && !a && !l || m ? u.onTextInput(r) : u.onTextInput(r, {
				extendLeft: s,
				extendRight: o,
				restoreStart: a,
				restoreEnd: l
		...
		function o(e) {
			if (h) return L();
			if (e && e.inputType) {
				if ("historyUndo" == e.inputType) return u.execCommand("undo");
				if ("historyRedo" == e.inputType) return u.execCommand("redo")
			}
			var t = d.value,
				i = s(t, !0);
			(500 < t.length || q.test(i) || X && v < 1 && v == w) && y()
		}

		function a(e, t) {
			var i = u.getCopyText();
			if (!i) return D.preventDefault(e);
			k(e, i) ? (j && (y(i), r = i, setTimeout(function () {
				r = !1
			}, 10)), t ? u.onCut() : u.onCopy(), D.preventDefault(e)) : (r = !0, d.value = i, d.select(), setTimeout(function () {
				r = !1, y(), t ? u.onCut() : u.onCopy()
			}))
		}
		...
		function x(e) {
			var t = k(e);
			N.pasteCancelled() || ("string" == typeof t ? (t && u.onPaste(t, e), B.isIE && setTimeout(y), D.preventDefault(e)) : (d.value = "", g = !0))
		}
		var A = !(this.getInputHandler = function () {
			return n
		}),
			k = function (e, t, i) {
		...
		D.addCommandKeyListener(d, u.onCommandKey.bind(u), u), D.addListener(d, "select", function (e) {
			var t;
			h || (r ? r = !1 : 0 === (t = d).selectionStart && t.selectionEnd >= p.length && t.value === p && p && t.selectionEnd !== w ? (u.selectAll(), y()) : X && d.selectionStart != v && y())
		}, u), D.addListener(d, "input", o, u), D.addListener(d, "cut", S, u), D.addListener(d, "copy", C, u), D.addListener(d, "paste", x, u), "oncut" in d && "oncopy" in d && "onpaste" in d || D.addListener(e, "keydown", function (e) {
		...
		var L = function () {
			if (h && u.onCompositionUpdate && !u.$readOnly) {
				if (m) return i();
				if (h.useTextareaForIME) u.onCompositionUpdate(d.value);
				else {
					var e = d.value;
					s(e), h.markerRange && (h.context && (h.markerRange.start.column = h.selectionStart = h.context.compositionStartOffset), h.markerRange.end.column = h.markerRange.start.column + w - h.selectionStart + $)
				}
			}
		},
			R = function (e) {
				u.onCompositionEnd && !u.$readOnly && (h = !1, u.onCompositionEnd(), u.off("mousedown", i), e && o())
			},
			E = H.delayedCall(L, 50).schedule.bind(null, null);
		D.addListener(d, "compositionstart", function (e) {
			if (!h && u.onCompositionStart && !u.$readOnly && (h = {}, !m)) {
				e.data && (h.useTextareaForIME = !1), setTimeout(L, 0), u._signal("compositionStart"), u.on("mousedown", i);
				var t = u.getSelectionRange();
				t.end.row = t.start.row, t.end.column = t.start.column, h.markerRange = t, h.selectionStart = v, u.onCompositionStart(h), h.useTextareaForIME ? (p = d.value = "", w = v = 0) : (d.msGetInputContext && (h.context = d.msGetInputContext()), d.getInputContext && (h.context = d.getInputContext()))
			}
		}, u), D.addListener(d, "compositionupdate", L, u), D.addListener(d, "keyup", function (e) {
			27 == e.keyCode && d.value.length < d.selectionStart && (h || (p = d.value), v = w = -1, y()), E()
		}, u), D.addListener(d, "keydown", E, u), D.addListener(d, "compositionend", R, u), this.getElement = function () {
			return d
			...
			A = !0, y(), u._emit("nativecontextmenu", {
				target: u,
				domEvent: e
			}), this.moveToMouse(e, !0)
		}, this.moveToMouse = function (e, t) {
			c = c || d.style.cssText, d.style.cssText = (t ? "z-index:100000;" : "") + (B.isIE ? "opacity:0.1;" : "") + "text-indent: -" + (v + w) * u.renderer.characterWidth * .5 + "px;";

			function i(e) {
				P.translate(d, e.clientX - r - 2, Math.min(e.clientY - o - 2, a))
			}
			var n = u.container.getBoundingClientRect(),
				s = P.computedStyle(u.container),
				o = n.top + (parseInt(s.borderTopWidth) || 0),
				r = n.left + (parseInt(n.borderLeftWidth) || 0),
				a = n.bottom - o - d.clientHeight - 2;
			i(e), "mousedown" == e.type && (u.renderer.$isMousePressed = !0, clearTimeout(_), B.isWin && D.capture(u.container, i, l))
		}, this.onContextMenuClose = l;

		function M(e) {
			u.textInput.onContextMenu(e), l()
		}
		var _, T, O, F, I;

		function W(e) {
			if (document.activeElement === O && !(I || h || T.$mouseHandler.isMousePressed || r)) {
				var t = O.selectionStart,
					i = O.selectionEnd,
					n = null,
					s = 0;
				if (0 == t ? n = K.up : 1 == t ? n = K.home : w < i && "\n" == p[i] ? n = K.end : t < v && " " == p[t - 1] ? (n = K.left, s = G.option) : t < v || t == v && w != v && t == i ? n = K.left : w < i && 2 < p.slice(0, i).split("\n").length ? n = K.down : w < i && " " == p[i - 1] ? (n = K.right, s = G.option) : (w < i || i == w && w != v && t == i) && (n = K.right), t !== i && (s |= G.shift), n) {
					if (!T.onCommandKey({}, s, n) && T.commands) {
						n = K.keyCodeToString(n);
						var o = T.commands.findKeyCommand(s, n);
						o && T.execCommand(o)
					}
					v = t, w = i, y("")
				}
		...
		D.addListener(d, "mouseup", M, u), D.addListener(d, "mousedown", function (e) {
			e.preventDefault(), l()
		}, u), D.addListener(u.renderer.scroller, "contextmenu", M, u), D.addListener(d, "contextmenu", M, u), j && (T = u, F = null, I = !1, (O = d).addEventListener("keydown", function (e) {
			F && clearTimeout(F), I = !0
		}, !0), O.addEventListener("keyup", function (e) {
			F = setTimeout(function () {
				I = !1
			}, 100)
		}, !0), document.addEventListener("selectionchange", W), T.on("destroy", function () {
	...
	(function () {
		this.onMouseDown = function (e) {
			...
			if (this.$clickSelection) {
				...
				if (-1 == o && r <= 0) t = this.$clickSelection.end, s.end.row == n.row && s.end.column == n.column || (n = s.start);
				else if (1 == r && 0 <= o) t = this.$clickSelection.start, s.start.row == n.row && s.start.column == n.column || (n = s.end);
				else if (-1 == o && 1 == r) n = s.end, t = s.start;
				else {
			...
			var e, t, i, n, s = (e = this.mousedownEvent.x, t = this.mousedownEvent.y, i = this.x, n = this.y, Math.sqrt(Math.pow(i - e, 2) + Math.pow(n - t, 2))),
				o = Date.now();
			...
			if (!e.getAccelKey()) {
				...
				var a = Math.abs(o / r),
					l = !1;
				if (1 <= a && t.renderer.isScrollableBy(e.wheelX * e.speed, 0) && (l = !0), a <= 1 && t.renderer.isScrollableBy(0, e.wheelY * e.speed) && (l = !0), l) i.allowed = n;
		...
		function () {
			this.setPosition = function (e, t) {
				var i = window.innerWidth || document.documentElement.clientWidth,
					...
					s = this.getWidth(),
					o = this.getHeight();
				i < (e += 15) + s && (e -= e + s - i), n < (t += 15) + o && (t -= 20 + o), r.prototype.setPosition.call(this, e, t)
			}
		}.call(n.prototype), t.GutterHandler = function (r) {
			function a() {
				i = i && clearTimeout(i), c && (g.hide(), c = null, u._signal("hideGutterTooltip", g), u.off("mousewheel", a))
			}

			function l(e) {
				g.setPosition(e.x, e.y)
			}
			var i, h, c, u = r.editor,
				d = u.renderer.$gutterLayer,
				g = new n(u.container);
			r.editor.setDefaultHandler("guttermousedown", function (e) {
				if (u.isFocused() && 0 == e.getButton() && "foldWidgets" != d.getRegion(e)) {
					...
					if (e.getShiftKey()) i.selectTo(t, 0);
					else {
						if (2 == e.domEvent.detail) return u.selectAll(), e.preventDefault();
				...
				if (s.hasCssClass(t, "ace_fold-widget")) return a();
				c && r.$tooltipFollowsMouse && l(e), h = e, i = i || setTimeout(function () {
					i = null, (h && !r.isMousePressed ? function () {
						var e = h.getDocumentPosition().row,
							t = d.$annotations[e];
						if (!t) return a();
						if (e == u.session.getLength()) {
							var i = u.renderer.pixelToScreenCoordinates(0, h.y).row,
								n = h.$pos;
							if (i > u.session.documentToScreenRow(n.row, n.column)) return a()
						}
						if (c != t)
							if (c = t.text.join("<br/>"), g.setHtml(c), g.show(), u._signal("showGutterTooltip", g), u.on("mousewheel", a), r.$tooltipFollowsMouse) l(h);
							else {
								var s = h.domEvent.target.getBoundingClientRect(),
									o = g.getElement().style;
								o.left = s.right + "px", o.top = s.bottom + "px"
							}
					} : a)()
				}, 50)
			}), f.addListener(u.renderer.$gutter, "mouseout", function (e) {
				h = null, c && !i && (i = setTimeout(function () {
					i = null, a()
				}, 50))
			}, u), u.on("changeSession", a)
		}
	...
	function n(t) {
		function e() {
			var e, t, i, n, s, o = u;
			u = g.renderer.screenToTextCoordinates(f, m), e = u, t = o, i = Date.now(), n = !t || e.row != t.row, s = !t || e.column != t.column, !w || n || s ? (g.moveCursorToPosition(e), w = i, $ = {
				x: f,
				y: m
			}) : 5 < C($.x, $.y, f, m) ? w = null : 200 <= i - w && (g.renderer.scrollCursorIntoView(), w = null),
				function (e, t) {
					var i = Date.now(),
					...
					a / s <= 2 && (h.column += r.x.left < r.x.right ? -3 : 2), l / n <= 1 && (h.row += r.y.top < r.y.bottom ? -1 : 1);
					var c = e.row != h.row,
						u = e.column != h.column,
						d = !t || e.row != t.row;
					c || u && !d ? v ? 200 <= i - v && g.renderer.scrollCursorIntoView(h) : v = i : v = null
				}(u, o)
		}

		function i() {
			c = g.selection.toOrientedRange(), l = g.session.addMarker(c, "ace_selection", g.getSelectionStyle()), g.clearSelection(), g.isFocused() && g.renderer.$cursorLayer.setBlinking(!1), clearInterval(h), e(), h = setInterval(e, 20), y = 0, A.addListener(document, "mousemove", s)
		}

		function n() {
			clearInterval(h), g.session.removeMarker(l), l = null, g.selection.fromOrientedRange(c), g.isFocused() && !p && g.$resetCursorStyle(), y = 0, w = v = u = c = null, A.removeListener(document, "mousemove", s)
		}
		...
		function r(e) {
			var t = ["copy", "copymove", "all", "uninitialized"],
				i = k.isMac ? e.altKey : e.ctrlKey,
				n = "uninitialized";
			try {
				n = e.dataTransfer.effectAllowed.toLowerCase()
			} catch (e) { }
			var s = "none";
			return i && 0 <= t.indexOf(n) ? s = "copy" : 0 <= ["move", "copymove", "linkmove", "all", "uninitialized"].indexOf(n) ? s = "move" : 0 <= t.indexOf(n) && (s = "copy"), s
		}
		var g = t.editor,
			a = x.createElement("img");
		a.src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", k.isOpera && (a.style.cssText = "width:1px;height:1px;position:fixed;top:0;left:0;z-index:2147483647;opacity:0;");
		["dragWait", "dragWaitEnd", "startDrag", "dragReadyEnd", "onMouseDrag"].forEach(function (e) {
			t[e] = this[e]
		}, this), g.on("mousedown", this.onMouseDown.bind(t));
		var l, f, m, h, c, u, d, p, v, w, $, b = g.container,
			y = 0;
		this.onDragStart = function (e) {
			...
			i.effectAllowed = g.getReadOnly() ? "copy" : "copyMove", k.isOpera && (g.container.appendChild(a), a.scrollTop = 0), i.setDragImage && i.setDragImage(a, 0, 0), k.isOpera && g.container.removeChild(a), i.clearData(), i.setData("Text", g.session.getTextRange()), p = !0, this.setState("drag")
		}, this.onDragEnd = function (e) {
			if (b.draggable = !1, p = !1, this.setState(null), !g.getReadOnly()) {
				var t = e.dataTransfer.dropEffect;
				d || "move" != t || g.session.remove(g.getSelectionRange()), g.$resetCursorStyle()
			}
			this.editor.unsetStyle("ace_dragging"), this.editor.renderer.setCursorStyle("")
		}, this.onDragEnter = function (e) {
			if (!g.getReadOnly() && o(e.dataTransfer)) return f = e.clientX, m = e.clientY, l || i(), y++, e.dataTransfer.dropEffect = d = r(e), A.preventDefault(e)
		}, this.onDragOver = function (e) {
			if (!g.getReadOnly() && o(e.dataTransfer)) return f = e.clientX, m = e.clientY, l || (i(), y++), null !== S && (S = null), e.dataTransfer.dropEffect = d = r(e), A.preventDefault(e)
		}, this.onDragLeave = function (e) {
			if (--y <= 0 && l) return n(), d = null, A.preventDefault(e)
			...
			if (u) {
				...
				return n(), A.preventDefault(e)
			}
		}, A.addListener(b, "dragstart", this.onDragStart.bind(t), g), A.addListener(b, "dragend", this.onDragEnd.bind(t), g), A.addListener(b, "dragenter", this.onDragEnter.bind(t), g), A.addListener(b, "dragover", this.onDragOver.bind(t), g), A.addListener(b, "dragleave", this.onDragLeave.bind(t), g), A.addListener(b, "drop", this.onDrop.bind(t), g);
		var S = null
	}
	...
	(function () {
		this.dragWait = function () {
			...
			var t = k.isWin ? "default" : "move";
			e.renderer.setCursorStyle(t), this.setState("dragReady")
		}, this.onMouseDrag = function (e) {
			var t = this.editor.container;
			k.isIE && "dragReady" == this.state && 3 < C(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y) && t.dragDrop();
			"dragWait" === this.state && 0 < C(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y) && (t.draggable = !1, this.startSelect(this.mousedownEvent.getDocumentPosition()))
		}, this.onMouseDown = function (e) {
			if (this.$dragEnabled) {
				this.mousedownEvent = e;
				var t = this.editor,
				...
				if (1 === (e.domEvent.detail || 1) && 0 === n && i) {
					...
					if ("unselectable" in s && (s.unselectable = "on"), t.getDragDelay()) {
						if (k.isWebKit) this.cancelDrag = !0, t.container.draggable = !0;
	...
	"use strict";
	var _ = e("./mouse_event").MouseEvent,
		o = e("../lib/event"),
		a = e("../lib/dom");
	t.addTouchListeners = function (e, v) {
		function n() {
			function t(e) {
				var t, i, n = e.target.getAttribute("action");
				if ("more" == n || !o) return o = !o, t = v.getCopyText(), i = v.session.getUndoManager().hasUndo(), void r.replaceChild(a.buildDom(o ? ["span", !t && ["span", {
				...
				"paste" == n ? s.readText().then(function (e) {
					v.execCommand(n, e)
				}) : n && ("cut" != n && "copy" != n || (s ? s.writeText(v.getCopyText()) : document.execCommand("copy")), v.execCommand(n)), r.firstChild.style.display = "none", o = !1, "openCommandPallete" != n && v.focus()
			}
			...
			r = a.buildDom(["div", {
				...
				ontouchstart: function (e) {
					k = "menu", e.stopPropagation(), e.preventDefault(), v.textInput.focus()
				},
		...
		function i() {
			r || n();
			var e = v.selection.cursor,
				t = v.renderer.textToScreenCoordinates(e.row, e.column),
				i = v.container.getBoundingClientRect();
			r.style.top = t.pageY - i.top - 3 + "px", r.style.right = "10px", r.style.display = "", r.firstChild.style.display = "none", v.on("input", s)
		}

		function s(e) {
			r && (r.style.display = "none"), v.off("input", s)
		}

		function w() {
			C = null, clearTimeout(C);
			var e = v.selection.getRange(),
				t = e.contains(x.row, x.column);
			!e.isEmpty() && t || (v.selection.moveToPosition(x), v.selection.selectWord()), k = "wait", i()
		}
		var $, b, y, S, C, t, x, A, r, k = "scroll",
			L = 0,
			R = 0,
			E = 0,
			M = 0;
		o.addListener(e, "contextmenu", function (e) {
			A && v.textInput.getElement().focus()
		}, v), o.addListener(e, "touchstart", function (e) {
			var t = e.touches;
			if (C || 1 < t.length) return clearTimeout(C), C = null, y = -1, void (k = "zoom");
			A = v.$mouseHandler.isMousePressed = !0;
			var i = v.renderer.layerConfig.lineHeight,
				n = v.renderer.layerConfig.lineHeight,
				s = e.timeStamp;
			S = s;
			var o = t[0],
				r = o.clientX,
				a = o.clientY;
			Math.abs($ - r) + Math.abs(b - a) > i && (y = -1), $ = e.clientX = r, b = e.clientY = a, E = M = 0;
			var l = new _(e, v);
			if (x = l.getDocumentPosition(), s - y < 500 && 1 == t.length && !L) R++, e.preventDefault(), e.button = 0,
				function () {
					C = null, clearTimeout(C), v.selection.moveToPosition(x);
					var e = 2 <= R ? v.selection.getLineRange(x.row) : v.session.getBracketRange(x);
					e && !e.isEmpty() ? v.selection.setRange(e) : v.selection.selectWord(), k = "wait"
				}();
			else {
				R = 0;
				var h = v.selection.cursor,
					c = v.selection.isEmpty() ? h : v.selection.anchor,
					u = v.renderer.$cursorLayer.getPixelPosition(h, !0),
					d = v.renderer.$cursorLayer.getPixelPosition(c, !0),
					g = v.renderer.scroller.getBoundingClientRect(),
					f = function (e, t) {
						return (e /= n) * e + (t = t / i - .75) * t
					};
				if (e.clientX < g.left) return void (k = "zoom");
				var m = f(e.clientX - g.left - u.left, e.clientY - g.top - u.top),
					p = f(e.clientX - g.left - d.left, e.clientY - g.top - d.top);
				m < 3.5 && p < 3.5 && (k = p < m ? "cursor" : "anchor"), k = p < 3.5 ? "anchor" : m < 3.5 ? "cursor" : "scroll", C = setTimeout(w, 450)
			}
			y = s
		}, v), o.addListener(e, "touchend", function (e) {
			A = v.$mouseHandler.isMousePressed = !1, t && clearInterval(t), "zoom" == k ? (k = "", L = 0) : C ? (v.selection.moveToPosition(x), L = 0, i()) : "scroll" == k ? (L += 60, t = setInterval(function () {
				L-- <= 0 && (clearInterval(t), t = null), Math.abs(E) < .01 && (E = 0), Math.abs(M) < .01 && (M = 0), L < 20 && (E *= .9), L < 20 && (M *= .9);
				var e = v.session.getScrollTop();
				v.renderer.scrollBy(10 * E, 10 * M), e == v.session.getScrollTop() && (L = 0)
			}, 10), s()) : i(), clearTimeout(C), C = null
		}, v), o.addListener(e, "touchmove", function (e) {
			C && (clearTimeout(C), C = null);
			var t = e.touches;
			if (!(1 < t.length || "zoom" == k)) {
				var i = t[0],
					n = $ - i.clientX,
					s = b - i.clientY;
				if ("wait" == k) {
					if (!(4 < n * n + s * s)) return e.preventDefault();
					k = "cursor"
				}
				$ = i.clientX, b = i.clientY, e.clientX = i.clientX, e.clientY = i.clientY;
				var o = e.timeStamp,
					r = o - S;
				if (S = o, "scroll" == k) {
					var a = new _(e, v);
					a.speed = 1, a.wheelX = n, a.wheelY = s, 10 * Math.abs(n) < Math.abs(s) && (n = 0), 10 * Math.abs(s) < Math.abs(n) && (s = 0), 0 != r && (E = n / r, M = s / r), v._emit("mousewheel", a), a.propagationStopped || (E = M = 0)
				} else {
					var l = new _(e, v).getDocumentPosition();
					"cursor" == k ? v.selection.moveCursorToPosition(l) : "anchor" == k && v.selection.setSelectionAnchor(l.row, l.column), v.renderer.scrollCursorIntoView(l), e.preventDefault()
				}
			}
		}, v)
	}
	...
	n._emit = n._dispatchEvent = function (e, t) {
		...
		if (i.length || n) {
			"object" == typeof t && t || (t = {}), t.type || (t.type = e), t.stopPropagation || (t.stopPropagation = o), t.preventDefault || (t.preventDefault = r), i = i.slice();
	...
	(function () {
		r.implement(this, a), this.defineOptions = function (i, e, n) {
			return i.$options || (this.$defaultOptions[e] = i.$options = {}), Object.keys(n).forEach(function (e) {
				var t = n[e];
				"string" == typeof t && (t = {
					forwardTo: t
				}), t.name || (t.name = e), "initialValue" in (i.$options[t.name] = t) && (i["$" + t.name] = t.initialValue)
			}), r.implement(i, l), this
	...
	m.get = function (e) {
		if (!w.hasOwnProperty(e)) throw new Error("Unknown config key: " + e);
		return w[e]
	}, m.set = function (e, t) {
		if (w.hasOwnProperty(e)) w[e] = t;
		else if (0 == this.setDefaultValue("", e, t)) throw new Error("Unknown config key: " + e)
	}, m.all = function () {
		return e.copyObject(w)
	}, m.$modes = {}, m.moduleUrl = function (e, t) {
		if (w.$moduleUrls[e]) return w.$moduleUrls[e];
		var i = e.split("/"),
		...
		if ("worker" == t && "-" == n) {
			...
			s = s.replace(o, "")
		} (!s || s == t) && 1 < i.length && (s = i[i.length - 2]);
		var r = w[t + "Path"];
		return null == r ? r = w.basePath : "/" == n && (t = n = ""), r && "/" != r.slice(-1) && (r += "/"), r + t + n + s + this.get("suffix")
	}, m.setModuleUrl = function (e, t) {
		return w.$moduleUrls[e] = t
	}, m.$loading = {}, m.loadModule = function (i, e) {
		var t, n;
		Array.isArray(i) && (n = i[0], i = i[1]);
		try {
			t = f(i)
		} catch (e) { }
		if (t && !m.$loading[i]) return e && e(t);
		if (m.$loading[i] || (m.$loading[i] = []), m.$loading[i].push(e), !(1 < m.$loading[i].length)) {
			function s() {
				f([i], function (t) {
					m._emit("load.module", {
						name: i,
					...
					var e = m.$loading[i];
					m.$loading[i] = null, e.forEach(function (e) {
						e && e(t)
					})
				})
			}
			if (!m.get("packaged")) return s();
			o.loadScript(m.moduleUrl(i, n), s), r()
		}
	};
	var r = function () {
		w.basePath || w.workerPath || w.modePath || w.themePath || Object.keys(w.$moduleUrls).length || (console.error("Unable to infer path to ace from script src,", "use ace.config.set('basePath', 'path') to enable dynamic loading of modes and themes", "or with webpack use ace/webpack-resolver"), r = function () { })
	};
	m.init = function (e) {
		if (v && v.document) {
			w.packaged = e || f.packaged || p.packaged || v.define && define.packaged;
			...
			for (var g in i && (t.base = t.base || i, t.packaged = !0), t.basePath = t.base, t.workerPath = t.workerPath || t.base, t.modePath = t.modePath || t.base, t.themePath = t.themePath || t.base, delete t.base, t) void 0 !== t[g] && m.set(g, t[g])
		}
	}, m.version = "1.4.10"
	...
	function n(s) {
		...
		function e(e) {
			document.hasFocus && document.hasFocus() && (s.isFocused() || document.activeElement != (s.textInput && s.textInput.getElement())) || window.focus(), s.focus()
		}
		this.editor = s, new r(this), new a(this), new l(this);
		var t = s.renderer.getMouseEventTarget();
		c.addListener(t, "click", this.onMouseEvent.bind(this, "click"), s), c.addListener(t, "mousemove", this.onMouseMove.bind(this, "mousemove"), s), c.addMultiMouseDownListener([t, s.renderer.scrollBarV && s.renderer.scrollBarV.inner, s.renderer.scrollBarH && s.renderer.scrollBarH.inner, s.textInput && s.textInput.getElement()].filter(Boolean), [400, 300, 250], this, "onMouseEvent", s), c.addMouseWheelListener(s.container, this.onMouseWheel.bind(this, "mousewheel"), s), h(s.container, s);
		var i = s.renderer.$gutter;
		c.addListener(i, "mousedown", this.onMouseEvent.bind(this, "guttermousedown"), s), c.addListener(i, "click", this.onMouseEvent.bind(this, "gutterclick"), s), c.addListener(i, "dblclick", this.onMouseEvent.bind(this, "gutterdblclick"), s), c.addListener(i, "mousemove", this.onMouseEvent.bind(this, "guttermousemove"), s), c.addListener(t, "mousedown", e, s), c.addListener(i, "mousedown", e, s), u.isIE && s.renderer.scrollBarV && (c.addListener(s.renderer.scrollBarV.element, "mousedown", e, s), c.addListener(s.renderer.scrollBarH.element, "mousedown", e, s)), s.on("mousemove", function (e) {
			if (!o.state && !o.$dragDelay && o.$dragEnabled) {
				var t = s.renderer.screenToTextCoordinates(e.x, e.y),
	...
	(function () {
		this.onMouseEvent = function (e, t) {
			...
			function s(e) {
				if (e) return u.isWebKit && !e.which && r.releaseMouse ? r.releaseMouse() : (r.x = e.clientX, r.y = e.clientY, t && t(e), r.mouseEvent = new d(e, r.editor), void (r.$mouseMoved = !0))
			}

			function o(e) {
				i.off("beforeEndOperation", l), clearInterval(h), a(), r[r.state + "End"] && r[r.state + "End"](e), r.state = "", r.isMousePressed = n.$isMousePressed = !1, n.$keepTextAreaAtCursor && n.$moveTextAreaToCursor(), r.$onCaptureMouseMove = r.releaseMouse = null, e && r.onMouseEvent("mouseup", e), i.endOperation()
			}
			var r = this,
				a = function () {
					r[r.state] && r[r.state](), r.$mouseMoved = !1
				};
			if (u.isOldIE && "dblclick" == e.domEvent.type) return setTimeout(function () {
				o(e)
			});
			var l = function (e) {
				r.releaseMouse && i.curOp.command.name && i.curOp.selectionChanged && (r[r.state + "End"] && r[r.state + "End"](), r.state = "", r.releaseMouse())
			};
			i.on("beforeEndOperation", l), i.startOperation({
				command: {
					name: "mouse"
				}
			}), r.$onCaptureMouseMove = s, r.releaseMouse = c.capture(this.editor.container, s, o);
			var h = setInterval(a, 20)
		}, this.releaseMouse = null, this.cancelContextMenu = function () {
			var t = function (e) {
				e && e.domEvent && "contextmenu" != e.domEvent.type || (this.editor.off("nativecontextmenu", t), e && e.domEvent && c.stopEvent(e.domEvent))
			}.bind(this);
			setTimeout(t, 10), this.editor.on("nativecontextmenu", t)
		}
	}).call(n.prototype), s.defineOptions(n.prototype, "mouseHandler", {
		scrollSpeed: {
			initialValue: 2
		},
		dragDelay: {
	...
	t.FoldHandler = function (r) {
		r.on("click", function (e) {
			...
			n && (e.getAccelKey() ? i.removeFold(n) : i.expandFold(n), e.stop());
			var s = e.domEvent && e.domEvent.target;
			s && o.hasCssClass(s, "ace_inline_button") && o.hasCssClass(s, "ace_toggle_wrap") && (i.setOption("wrap", !i.getUseWrapMode()), r.renderer.scrollCursorIntoView())
		}), r.on("gutterclick", function (e) {
			if ("foldWidgets" == r.renderer.$gutterLayer.getRegion(e)) {
				var t = e.getDocumentPosition().row,
					i = r.session;
				i.foldWidgets && i.foldWidgets[t] && r.session.onFoldWidgetClick(t, e), r.isFocused() || r.focus(), e.stop()
			}
		}), r.on("gutterdblclick", function (e) {
			if ("foldWidgets" == r.renderer.$gutterLayer.getRegion(e)) {
				var t = e.getDocumentPosition().row,
					i = r.session,
					n = i.getParentFoldRangeData(t, !0),
					s = n.range || n.firstRange;
				if (s) {
					t = s.start.row;
					var o = i.getFoldAt(t, i.getLine(t).length, 1);
					o ? i.removeFold(o) : (i.addFold("...", s), r.renderer.scrollCursorIntoView({
						row: s.start.row,
						column: 0
					}))
				}
	...
	(function () {
		this.setDefaultHandler = function (e) {
			...
			for (var s, o = !1, r = this.$editor.commands, a = this.$handlers.length; a-- && !((s = this.$handlers[a].handleKeyboard(this.$data, e, t, i, n)) && s.command && ((o = "null" == s.command || r.exec(s.command, this.$editor, s.args, n)) && n && -1 != e && 1 != s.passEvent && 1 != s.command.passEvent && l.stopEvent(n), o)););
			return o || -1 != e || (s = {
				command: "insertstring"
			}, o = r.exec("insertstring", this.$editor, t)), o && this.$editor._signal && this.$editor._signal("keyboardActivity", s), o
	...
	}).call(n.prototype), t.KeyBinding = n
			...
			if (1 != e || 1 != v || b)
				for (var n, s, o, r, a = i.length, l = 0; l < a;) {
					if (t[l] >= e) {
						...
						for (s = l, o = n - 1; s < o; s++, o--) r = i[s], i[s] = i[o], i[o] = r;
						l = n
					}
					l++
				} else i.reverse()
	...
	function m(e, t, i, n) {
		...
		switch (l) {
			...
			case R:
				return x;
			case E:
				return n < 1 || n + 1 >= t.length || (s = i[n - 1]) != g && s != f || (o = t[n + 1]) != g && o != f ? x : ($ && (o = f), o == s ? o : x);
			case M:
				return (s = 0 < n ? i[n - 1] : A) == g && n + 1 < t.length && t[n + 1] == g ? g : x;
			case _:
				if (0 < n && i[n - 1] == g) return g;
				if ($) return x;
				for (a = n + 1, r = t.length; a < r && t[a] == _;) a++;
				return a < r && t[a] == g ? g : x;
			case T:
				for (r = t.length, a = n + 1; a < r && t[a] == T;) a++;
				if (a < r) {
					var h = e[n],
						c = 1425 <= h && h <= 2303 || 64286 == h;
					if (s = t[a], c && (s == d || s == L)) return d
				}
				return n < 1 || (s = t[n - 1]) == A ? x : i[n - 1];
			case A:
				return b = !($ = !1), v;
			case k:
				return y = !0, x;
	...
	function p(e) {
		var t = e.charCodeAt(0),
			i = t >> 8;
		return 0 == i ? 191 < t ? u : n[t] : 5 == i ? /[\u0591-\u05f4]/.test(e) ? d : u : 6 == i ? /[\u0610-\u061a\u064b-\u065f\u06d6-\u06e4\u06e7-\u06ed]/.test(e) ? T : /[\u0660-\u0669\u066b-\u066c]/.test(e) ? f : 1642 == t ? _ : /[\u06f0-\u06f9]/.test(e) ? g : L : 32 == i && t <= 8287 ? s[255 & t] : 254 == i && 65136 <= t ? L : x
	}
	var v = 0,
		w = 0,
		$ = !1,
		...
		D = 17,
		B = 18,
		n = [B, B, B, B, B, B, B, B, B, k, A, k, R, A, B, B, B, B, B, B, B, B, B, B, B, B, B, B, A, A, A, k, R, x, x, _, _, _, x, x, x, x, x, M, E, M, E, E, g, g, g, g, g, g, g, g, g, g, E, x, x, x, x, x, x, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, x, x, x, x, x, x, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, u, x, x, x, x, B, B, B, B, B, B, A, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, E, x, _, _, _, _, x, x, x, x, u, x, x, B, x, x, _, _, g, g, x, u, x, x, x, g, u, x, x, x, x, x],
		s = [R, R, R, R, R, R, R, R, R, R, R, B, B, B, u, d, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, R, A, O, F, I, W, D, E, _, _, _, _, _, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, E, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, x, R];
	l.L = u, l.R = d, l.EN = g, l.ON_R = 3, l.AN = 4, l.R_H = 5, l.B = 6, l.RLE = 7, l.DOT = "·", l.doBidiReorder = function (e, t, i) {
		...
		v = i ? 1 : 0,
			function (e, t, i, n) {
				var s = v ? C : S,
					...
					g = [];
				if (!n)
					for (u = 0, n = []; u < i; u++) n[u] = p(e[u]);
				for (w = v, y = b = $ = !1, d = 0; d < i; d++) {
					if (o = l, g[d] = r = m(e, n, g, d), h = 240 & (l = s[o][r]), l &= 15, t[d] = a = s[l][5], 0 < h)
						if (16 == h) {
							for (u = c; u < d; u++) t[u] = 1;
							c = -1
						} else c = -1;
				...
				if (y)
					for (u = 0; u < i; u++)
						if (n[u] == k) {
							t[u] = v;
							for (var f = u - 1; 0 <= f && n[f] == R; f--) t[f] = v
						}
			}(n, r, n.length, t);
		for (var a = 0; a < s.length; s[a] = a, a++);
		h(2, r, s), h(1, r, s);
		for (a = 0; a < s.length - 1; a++) t[a] === f ? r[a] = l.AN : r[a] === d && (t[a] > L && t[a] < O || t[a] === x || t[a] === B) ? r[a] = l.ON_R : 0 < a && "ل" === n[a - 1] && /\u0622|\u0623|\u0625|\u0627/.test(n[a]) && (r[a - 1] = r[a] = l.R_H, a++);
		n[n.length - 1] === l.DOT && (r[n.length - 1] = l.B), "‫" === n[0] && (r[0] = l.RLE);
		for (a = 0; a < s.length; a++) o[a] = r[s[a]];
		return {
			logicalFromVisual: s,
			bidiLevels: o
		}
	}, l.hasBidiCharacters = function (e, t) {
		for (var i = !1, n = 0; n < e.length; n++) t[n] = p(e.charAt(n)), i || t[n] != d && t[n] != L && t[n] != f || (i = !0);
		return i
	...
	(function () {
		this.isBidiRow = function (e, t, i) {
			...
			if (t.length) {
				...
				0 <= i && (e = this.session.$docRowCache[i])
			}
			return e
			...
			var e = 0,
				t = this.session.$screenRowCache;
			if (t.length)
				for (var i, n = this.session.$getRowCacheIndex(t, this.currentRow); 0 < this.currentRow - e && (i = this.session.$getRowCacheIndex(t, this.currentRow - e - 1)) === n;) n = i, e++;
			...
			if (this.wrapIndent = 0, this.line = this.session.getLine(e), this.isRtlDir = this.$isRtl || this.line.charAt(0) === this.RLE, this.session.$useWrapMode) {
				...
				n && (void 0 === t && (t = this.getSplitIndex()), 0 < t && n.length ? (this.wrapIndent = n.indent, this.wrapOffset = this.wrapIndent * this.charWidths[a.L], this.line = t < n.length ? this.line.substring(n[t - 1], n[t]) : this.line.substring(n[n.length - 1])) : this.line = this.line.substring(0, n[t])), t == n.length && (this.line += this.showInvisibles ? i : a.DOT)
			} else this.line += this.showInvisibles ? i : a.DOT;
			var s, o = this.session,
				r = 0;
			this.line = this.line.replace(/\t|[\u1100-\u2029, \u202F-\uFFE6]/g, function (e, t) {
				return "\t" === e || o.isFullWidth(e.charCodeAt(0)) ? (s = "\t" === e ? o.getScreenTabSize(t + r) : 2, r += s - 1, l.stringRepeat(a.DOT, s)) : e
			...
			if (this.characterWidth !== e.$characterSize.width) {
				...
				this.charWidths[a.L] = this.charWidths[a.EN] = this.charWidths[a.ON_R] = t, this.charWidths[a.R] = this.charWidths[a.AN] = i, this.charWidths[a.R_H] = .45 * i, this.charWidths[a.B] = this.charWidths[a.RLE] = 0, this.currentRow = null
			}
			...
			for (var r = 0; r < n; r++) o += this.charWidths[s[r]];
			return !this.session.getOverwrite() && t < e && s[n] % 2 == 0 && (o += this.charWidths[s[n]]), this.wrapIndent && (o += this.isRtlDir ? -1 * this.wrapOffset : this.wrapOffset), this.isRtlDir && (o += this.rtlLineOffset), o
			...
			for (var d, g = 0; g < s.length; g++) d = n.logicalFromVisual[g], i = s[g], (h = a <= d && d < l) && !c ? u = r : !h && c && o.push({
				left: u,
				width: r - u
	...
	var s = e("./lib/oop"),
		...
		a = e("./range").Range;
	(function () {
		s.implement(this, o), this.isEmpty = function () {
			...
			if (!this.$silent) {
				...
				this.$silent = !0, this.$cursorChanged = this.$anchorChanged = !1, this.anchor.setPosition(e, t), this.cursor.setPosition(i, n), this.$isEmpty = !a.comparePoints(this.anchor, this.cursor), this.$silent = !1, this.$cursorChanged && this._emit("changeCursor"), (this.$cursorChanged || this.$anchorChanged || s != this.$isEmpty || o) && this._emit("changeSelection")
			}
			...
			return i = s ? (n = s.start.row, s.end.row) : n, !0 === t ? new a(n, 0, i, this.session.getLine(i).length) : new a(n, 0, i + 1, 0)
			...
			else if (0 === t.column) 0 < t.row && this.moveCursorTo(t.row - 1, this.doc.getLine(t.row - 1).length);
			else {
			...
			if (e = this.session.getFoldAt(t, i, -1)) this.moveCursorTo(e.start.row, e.start.column);
				...
				if (this.session.nonTokenRe.lastIndex = 0, this.session.tokenRe.lastIndex = 0, this.session.nonTokenRe.exec(s) && (i -= this.session.nonTokenRe.lastIndex, s = s.slice(this.session.nonTokenRe.lastIndex), this.session.nonTokenRe.lastIndex = 0), i <= 0) return this.moveCursorTo(t, 0), this.moveCursorLeft(), void (0 < t && this.moveCursorWordLeft());
			...
			if (t == i.length) {
				for (var o = this.doc.getLength(); e++, n = this.doc.getLine(e), e < o && /^\s*$/.test(n););
				/^\s+/.test(n) || (n = ""), t = 0
			}
			...
			if (0 === i) {
				for (; t--, n = this.doc.getLine(t), 0 < t && /^\s*$/.test(n););
			...
			if (0 === t && (0 !== e && (this.session.$bidiHandler.isBidiRow(n.row, this.lead.row) ? (i = this.session.$bidiHandler.getPosLeft(n.column), n.column = Math.round(i / this.session.$bidiHandler.charWidths[0])) : i = n.column * this.session.$bidiHandler.charWidths[0]), this.$desiredColumn ? n.column = this.$desiredColumn : this.$desiredColumn = n.column), 0 != e && this.session.lineWidgets && this.session.lineWidgets[this.lead.row]) {
				...
				e < 0 ? e -= s.rowsAbove || 0 : 0 < e && (e += s.rowCount - (s.rowsAbove || 0))
			}
			...
			/[\uDC00-\uDFFF]/.test(s.charAt(t)) && s.charAt(t - 1) && (this.lead.row == e && this.lead.column == t + 1 ? --t : t += 1), this.lead.setPosition(e, t), this.$keepDesiredColumnOnChange = !1, i || (this.$desiredColumn = null)
	...
	}).call(n.prototype), t.Selection = n
			...
			for (var i = this.states[t], n = [], s = 0, o = this.matchMappings[t] = {
				...
				if (h.defaultToken && (o.defaultToken = h.defaultToken), h.caseInsensitive && (r = "gi"), null != h.regex) {
					...
					Array.isArray(h.token) ? 1 == h.token.length || 1 == u ? h.token = h.token[0] : u - 1 != h.token.length ? (this.reportError("number of classes and regexp groups doesn't match", {
						rule: h,
						groupCount: u - 1
					}), h.token = h.token[0]) : (h.tokenArray = h.token, h.token = null, h.onMatch = this.$arrayTokens) : "function" != typeof h.token || h.onMatch || (h.onMatch = 1 < u ? this.$applyToken : h.token), 1 < u && (c = /\\\d/.test(h.regex) ? h.regex.replace(/\\([0-9]+)/g, function (e, t) {
						return "\\" + (parseInt(t, 10) + s + 1)
					}) : (u = 1, this.removeCapturingGroups(h.regex)), h.splitRegex || "string" == typeof h.token || a.push(h)), o[s] = l, s += u, n.push(c), h.onMatch || (h.onMatch = null)
				}
			}
		...
		this.$setMaxTokenCount = function (e) {
			...
			if (-1 != e.indexOf("(?=")) {
				...
				e.replace(/(\\.)|(\((?:\?[=!])?)|(\))|([\[\]])/g, function (e, t, i, n, s, o) {
					return a ? a = "]" != s : s ? a = !0 : n ? (r == l.stack && (l.end = o + 1, l.stack = -1), r--) : i && (r++, 1 != i.length && (l.stack = r, l.start = o)), e
			...
			if (t && "string" != typeof t) "#tmp" === (t = (i = t.slice(0))[0]) && (i.shift(), t = i.shift());
			else var i = [];
			var n = t || "start",
				s = this.states[n];
			...
			for (var o, r = this.matchMappings[n], a = this.regExps[n], l = [], h = a.lastIndex = 0, c = 0, u = {
				...
				if (m - f.length > h) {
					...
					u.type == d ? u.value += p : (u.type && l.push(u), u = {
						type: d,
						value: p
					})
				}
				for (var v = 0; v < o.length - 2; v++)
					if (void 0 !== o[v + 1]) {
						d = (g = s[r[v]]).onMatch ? g.onMatch(f, n, i, e) : g.token, g.next && (n = "string" == typeof g.next ? g.next : g.next(n, i), (s = this.states[n]) || (this.reportError("state doesn't exist", n), n = "start", s = this.states[n]), r = this.matchMappings[n], h = m, (a = this.regExps[n]).lastIndex = m), g.consumeLineEnd && (h = m);
						break
					} if (f)
					if ("string" == typeof d) g && !1 === g.merge || u.type !== d ? (u.type && l.push(u), u = {
						type: d,
						value: f
					}) : u.value += f;
					else if (d) {
						...
						for (v = 0; v < d.length; v++) l.push(d[v])
					}
				if (h == e.length) break;
				if (h = m, c++ > w) {
			...
			return u.type && l.push(u), 1 < i.length && i[0] !== n && i.unshift("#tmp", n), {
				tokens: l,
				state: i.length ? i : n
			}
	...
	(function () {
		this.addRules = function (e, t) {
			...
			if (n)
				...
				for (var a in n = [], o) n.push(t + a);
			if (this.addRules(o, t), i) {
				var l = Array.prototype[s ? "push" : "unshift"];
				for (r = 0; r < n.length; r++) l.apply(this.$rules[n[r]], h.deepCopy(i))
			}
		...
		this.normalizeRules = function () {
			...
			Object.keys(d).forEach(function e(t) {
				...
				for (var n = 0; n < i.length; n++) {
					var s = i[n],
						o = null;
					Array.isArray(s) && (o = s, s = {}), !s.regex && s.start && (s.regex = s.start, s.next || (s.next = []), s.next.push({
					...
					if (r && Array.isArray(r)) {
						var a = s.stateName;
						a || ("string" != typeof (a = s.token) && (a = a[0] || ""), d[a] && (a += u++)), d[a] = r, e(s.next = a)
					} else "pop" == r && (s.next = f);
					if (s.push && (s.nextState = s.next || s.push, s.next = g, delete s.push), s.rules)
						for (var l in s.rules) d[l] ? d[l].push && d[l].push.apply(d[l], s.rules[l]) : d[l] = s.rules[l];
					var h = "string" == typeof s ? s : s.include;
					if (h && (o = Array.isArray(h) ? h.map(function (e) {
						return d[e]
					}) : d[h]), o) {
						var c = [n, 1].concat(o);
						s.noEscape && (c = c.filter(function (e) {
							return !e.next
						})), i.splice.apply(i, c), n--
					}
			...
			return Object.keys(s).forEach(function (e) {
				var t = s[e];
				o && (t = t.toLowerCase());
				for (var i = t.split(r || "|"), n = i.length; n--;) a[i[n]] = e
			}), Object.getPrototypeOf(a) && (a.__proto__ = null), this.$keywordList = Object.keys(a), s = null, o ? function (e) {
	...
	function S(e) {
		var t = -1;
		if (e.multiSelect && (t = e.selection.index, l.rangeCount != e.multiSelect.rangeCount && (l = {
	...
	var f, n = e("../../lib/oop"),
		...
		m = e("../../lib/lang"),
		r = ["text", "paren.rparen", "rparen", "paren", "punctuation.operator"],
		...
		p = function (g) {
			this.add("braces", "insertion", function (e, t, i, n, s) {
				...
				if ("{" == s) {
					...
					if ("" !== l && "{" !== l && i.getWrapBehavioursEnabled()) return C(a, l, "{", "}");
					if (p.isSaneInsertion(i, n)) return /[\]\}\)]/.test(r[o.column]) || i.inMultiSelectMode || g && g.braces ? (p.recordAutoInsert(i, n, "}"), {
						text: "{}",
						selection: [1, 1]
					...
					if (S(i), "}" == r.substring(o.column, o.column + 1))
						if (null !== n.$findOpeningBracket("}", {
							column: o.column + 1,
							row: o.row
						}) && p.isAutoInsertedClosing(o, r, s)) return p.popAutoInsertedClosing(), {
							text: "",
							selection: [1, 1]
						}
				} else {
					if ("\n" == s || "\r\n" == s) {
						S(i);
						var h = "";
						if (p.isMaybeInsertedClosing(o, r) && (h = m.stringRepeat("}", f.maybeInsertedBrackets), p.clearMaybeInsertedClosing()), "}" === r.substring(o.column, o.column + 1)) {
							...
							if (!h) return void p.clearMaybeInsertedClosing();
							u = this.$getIndent(r)
						}
				...
				if (!s.isMultiLine() && "{" == o) {
					if (S(i), "}" == n.doc.getLine(s.start.row).substring(s.end.column, s.end.column + 1)) return s.end.column++, s;
				...
				if ("(" == s) {
					...
					if ("" !== r && i.getWrapBehavioursEnabled()) return C(o, r, "(", ")");
					if (p.isSaneInsertion(i, n)) return p.recordAutoInsert(i, n, ")"), {
						text: "()",
						selection: [1, 1]
					}
				} else if (")" == s) {
					...
					if (")" == l.substring(a.column, a.column + 1))
						if (null !== n.$findOpeningBracket(")", {
							column: a.column + 1,
							row: a.row
						}) && p.isAutoInsertedClosing(a, l, s)) return p.popAutoInsertedClosing(), {
							text: "",
							selection: [1, 1]
						}
				}
				...
				var o = n.doc.getTextRange(s);
				if (!s.isMultiLine() && "(" == o && (S(i), ")" == n.doc.getLine(s.start.row).substring(s.start.column + 1, s.start.column + 2))) return s.end.column++, s
				...
				if (1 == s.length && o[s]) {
					...
					var r = s,
						...
						l = n.doc.getTextRange(a);
					if ("" !== l && (1 != l.length || !o[l]) && i.getWrapBehavioursEnabled()) return C(a, l, r, r);
					if (!l) {
						...
						var m, p = g && /string|escape/.test(g.type),
							v = !f || /string|escape/.test(f.type);
						if (d == r) (m = p !== v) && /string\.end/.test(f.type) && (m = !1);
						else {
							if (p && !v) return null;
							if (p && v) return null;
							...
							var y = c[h.column - 2];
							if (u == r && (y == r || w.test(y))) return null;
							m = !0
						}
						return {
							text: m ? r + r : "",
				...
				if (!s.isMultiLine() && o.hasOwnProperty(r) && (S(i), n.doc.getLine(s.start.row).substring(s.start.column + 1, s.start.column + 2) == r)) return s.end.column++, s
			})
		};
	p.isSaneInsertion = function (e, t) {
		...
		if (!this.$matchTokenType(n.getCurrentToken() || "text", r)) {
			...
			if (!this.$matchTokenType(s.getCurrentToken() || "text", r)) return !1
		}
		...
		this.isAutoInsertedClosing(n, s, f.autoInsertedLineEnd[0]) || (f.autoInsertedBrackets = 0), f.autoInsertedRow = n.row, f.autoInsertedLineEnd = i + s.substr(n.column), f.autoInsertedBrackets++
	}, p.recordMaybeInsert = function (e, t, i) {
		var n = e.getCursorPosition(),
			s = t.doc.getLine(n.row);
		this.isMaybeInsertedClosing(n, s) || (f.maybeInsertedBrackets = 0), f.maybeInsertedRow = n.row, f.maybeInsertedLineStart = s.substr(0, n.column) + i, f.maybeInsertedLineEnd = s.substr(n.column), f.maybeInsertedBrackets++
	...
	}, n.inherits(p, s), t.CstyleBehaviour = p
	...
	(function () {
		this.$defaultBehaviour = new a, this.tokenRe = new RegExp("^[" + l.wordChars + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + l.wordChars + "\\$_]|\\s])+", "g"), this.getTokenizer = function () {
		...
		}, this.lineCommentStart = "", this.blockComment = "", this.toggleCommentLines = function (e, s, i, n) {
			function t(e) {
			...
			if (this.lineCommentStart) {
				if (Array.isArray(this.lineCommentStart)) m = this.lineCommentStart.map(y.escapeRegExp).join("|"), g = this.lineCommentStart[0];
				else m = y.escapeRegExp(this.lineCommentStart), g = this.lineCommentStart;
				m = new RegExp("^(\\s*)(?:" + m + ") ?"), c = s.getUseSoftTabs();
				w = function (e, t) {
					var i = e.match(m);
					if (i) {
						var n = i[1].length,
							s = i[0].length;
						d(e, n, s) || " " != i[0][s - 1] || s--, o.removeInLine(t, n, s)
					}
				};
				var u = g + " ",
					d = (v = function (e, t) {
						r && !/\S/.test(e) || (d(e, l, l) ? o.insertInLine({
							row: t,
							column: l
						}, u) : o.insertInLine({
							row: t,
				...
				var g = this.blockComment.start,
					...
					m = new RegExp("^(\\s*)(?:" + y.escapeRegExp(g) + ")"),
					p = new RegExp("(?:" + y.escapeRegExp(f) + ")\\s*$"),
					v = function (e, t) {
					...
					w = function (e, t) {
						var i;
						(i = e.match(p)) && o.removeInLine(t, e.length - i[0].length, e.length), (i = e.match(m)) && o.removeInLine(t, i[1].length, i[0].length)
					},
					$ = function (e, t) {
						if (m.test(e)) return !0;
						for (var i = s.getTokens(t), n = 0; n < i.length; n++)
							if ("comment" === i[n].type) return !0
					}
			}
			var b = 1 / 0;
			t(function (e, t) {
				var i = e.search(/\S/); - 1 !== i ? (i < l && (l = i), a && !$(e, t) && (a = !1)) : b > e.length && (b = e.length)
			}), l == 1 / 0 && (l = b, a = r = !1), c && l % h != 0 && (l = Math.floor(l / h) * h), t(a ? w : v)
		}, this.toggleBlockComment = function (e, t, i, n) {
			var s = this.blockComment;
			if (s) {
				!s.start && s[0] && (s = s[0]);
				var o, r, a = (g = new m(t, n.row, n.column)).getCurrentToken(),
					l = (t.selection, t.selection.toOrientedRange());
				if (a && /comment/.test(a.type)) {
					for (var h, c; a && /comment/.test(a.type);) {
						if (-1 != (f = a.value.indexOf(s.start))) {
							var u = g.getCurrentTokenRow(),
								d = g.getCurrentTokenColumn() + f;
							h = new p(u, d, u, d + s.start.length);
							break
						}
						a = g.stepBackward()
					}
					var g;
					for (a = (g = new m(t, n.row, n.column)).getCurrentToken(); a && /comment/.test(a.type);) {
						var f;
						if (-1 != (f = a.value.indexOf(s.end))) {
							u = g.getCurrentTokenRow(), d = g.getCurrentTokenColumn() + f;
							c = new p(u, d, u, d + s.end.length);
							break
						}
						a = g.stepForward()
					}
					c && t.remove(c), h && (t.remove(h), o = h.start.row, r = -s.start.length)
	...
	(function () {
		...
		n.implement(this, s), this.getPosition = function () {
			...
			if (!(e.start.row == e.end.row && e.start.row != this.row || e.start.row > this.row)) {
				var t, i, n, s, o, r, a, l, h = (t = e, i = {
					row: this.row,
					column: this.column
				}, n = this.$insertRight, s = "insert" == t.action, o = (s ? 1 : -1) * (t.end.row - t.start.row), r = (s ? 1 : -1) * (t.end.column - t.start.column), a = t.start, l = s ? a : t.end, c(i, a, n) ? {
					row: i.row,
					column: i.column
				} : c(l, i, !n) ? {
					row: i.row + o,
	...
	var s = e("./lib/oop"),
		...
		a = e("./anchor").Anchor;
	(function () {
		s.implement(this, r), this.setValue = function (e) {
			var t = this.getLength() - 1;
			this.remove(new c(0, 0, t, this.getLine(t).length)), this.insert({
				row: 0,
				column: 0
			}, e)
			...
			var i = 0;
			i = (e = Math.min(Math.max(e, 0), this.getLength())) < this.getLength() ? (t = t.concat([""]), 0) : (t = [""].concat(t), e--, this.$lines[e].length), this.insertMergedLines({
				row: e,
				column: i
			}, t)
			...
			return e instanceof c || (e = c.fromPoints(e.start, e.end)), 0 === t.length && e.isEmpty() ? e.start : t == this.getTextRange(e) ? e.end : (this.remove(e), t ? this.insert(e.start, t) : e.start)
			...
			(i ? e.lines.length <= 1 && !e.lines[0] : !c.comparePoints(e.start, e.end)) || (i && 2e4 < e.lines.length ? this.$splitAndapplyLargeDelta(e, 2e4) : (o(this.$lines, e, t), this._signal("change", e)))
	...
	function n(e, t) {
		...
		this.$worker = function () {
			if (a.running) {
				for (var e = new Date, t = a.currentLine, i = -1, n = a.doc, s = t; a.lines[t];) t++;
				var o = n.getLength(),
					r = 0;
				for (a.running = !1; t < o;) {
				...
				a.currentLine = t, -1 == i && (i = t), s <= i && a.fireUpdateEvent(s, i)
			}
		}
	}
	var s = e("./lib/oop"),
		o = e("./lib/event_emitter").EventEmitter;
	(function () {
		s.implement(this, o), this.setTokenizer = function (e) {
			...
			else if ("remove" == e.action) this.lines.splice(t, 1 + i, null), this.states.splice(t, 1 + i, null);
			else {
				var n = Array(1 + i);
	...
	}).call(n.prototype), t.BackgroundTokenizer = n
		...
		this.MAX_RANGES = 500, this.setRegexp = function (e) {
			...
			if (this.regExp)
				for (var s = n.firstRow, o = n.lastRow, r = s; r <= o; r++) {
					var a = this.cache[r];
					null == a && ((a = h.getMatchOffsets(i.getLine(r), this.regExp)).length > this.MAX_RANGES && (a = a.slice(0, this.MAX_RANGES)), a = a.map(function (e) {
	...
	}).call(n.prototype), t.SearchHighlight = n
	...
	(function () {
		this.comparePoints = l, this.pointIndex = function (e, t, i) {
			...
			if (0 <= t) return this.ranges.splice(t, 1)
		}, this.merge = function () {
			for (var e, t = [], i = this.ranges, n = (i = i.sort(function (e, t) {
				...
				o < 0 || (0 != o || e.isEmpty() || n.isEmpty()) && (l(e.end, n.end) < 0 && (e.end.row = n.end.row, e.end.column = n.end.column), i.splice(s, 1), t.push(n), n = e, s--)
			}
			...
			if ("insert" == e.action)
				for (var l = s - n, h = -t.column + i.column; r < a; r++) {
					...
					if (c.start.row == n && c.start.column >= t.column && (c.start.column == t.column && this.$bias <= 0 || (c.start.column += h, c.start.row += l)), c.end.row == n && c.end.column >= t.column) {
						...
						c.end.column == t.column && 0 < h && r < a - 1 && c.end.column > c.start.column && c.end.column == o[r + 1].start.column && (c.end.column -= h), c.end.column += h, c.end.row += l
					}
				} else
		...
		function () {
			this.toString = function () {
				...
				if (!this.range.isEqual(e)) {
					var t, i;
					t = e, i = this.start, g(t.start, i), g(t.end, i);
					...
					var a = this.subFolds[o],
						l = 0;
					if (0 == r) {
						if (a.range.containsRange(e)) return a.addSubFold(e);
						l = 1
					}
					n = e.range.end.row, s = e.range.end.column;
					var h = o;
					for (r = -1; h < this.subFolds.length && 1 == (r = this.subFolds[h].range.compare(n, s)); h++);
					0 == r && h++;
					for (var c = this.subFolds.splice(o, h - o, e), u = 0 == r ? c.length - 1 : c.length, d = l; d < u; d++) e.addSubFold(c[d]);
					return e.setFoldLine(this.foldLine), e
				}
			}, this.restoreRange = function (e) {
				return t = e, i = this.start, n(t.start, i), void n(t.end, i);
				var t, i
			}
		}.call(r.prototype)
	...
	t.Folding = function () {
		this.getFoldAt = function (e, t, i) {
			...
			var i, n = this.$foldData,
				s = !1;
			e instanceof p ? i = e : (i = new p(t, e)).collapseChildren = t.collapseChildren, this.$clipRangeToDocument(i.range);
			var o = i.start.row,
				r = i.start.column,
				a = i.end.row,
				l = i.end.column,
			...
			if (h && c == h) return h.addSubFold(i);
			h && !h.range.isStart(o, r) && this.removeFold(h), c && !c.range.isEnd(a, l) && this.removeFold(c);
			var u = this.getFoldsInRange(i.range);
			0 < u.length && (this.removeFolds(u), u.forEach(function (e) {
				i.addSubFold(e)
			}));
			for (var d = 0; d < n.length; d++) {
				...
				if (a <= g.start.row) break
			}
			return s || (g = this.$addFoldLine(new m(this.$foldData, i))), this.$useWrapMode ? this.$updateWrapData(g.start.row, g.start.row) : this.$updateRowLengthCache(g.start.row, g.start.row), this.$modified = !0, this._signal("changeFold", {
				data: i,
				action: "add"
			}), i
			...
			var i, n;
			if (null == e ? (i = new c(0, 0, this.getLength(), 0), t = !0) : i = "number" == typeof e ? new c(e, 0, e, this.getLine(e).length) : "row" in e ? c.fromPoints(e, e) : e, n = this.getFoldsInRangeList(i), t) this.removeFolds(n);
			else
				for (var s = n; s.length;) this.expandFolds(s), s = this.getFoldsInRangeList(i);
			...
			null == s && (s = e.start.row), null == o && (o = 0), null == t && (t = e.end.row), null == i && (i = this.getLine(t).length);
			var r = this.doc,
				a = "";
			...
			if ((t = t || this.getFoldAt(n.start.row, n.start.column)) && t.range.toString() == n.toString()) this.expandFold(t);
			else {
				var r = "...";
				if (!n.isMultiLine()) {
			...
			if (s && /^comment|string/.test(o)) {
				...
				if (1 != i) {
					for (;
						(s = n.stepBackward()) && r.test(s.type););
					n.stepForward()
				}
				if (a.start.row = n.getCurrentTokenRow(), a.start.column = n.getCurrentTokenColumn() + 2, n = new u(this, e, t), -1 != i) {
					var l = -1;
					do {
						if (s = n.stepForward(), -1 == l) {
							var h = this.getState(n.$row);
							r.test(h) || (l = n.$row)
						} else if (n.$row > l) break
					} while (s && r.test(s.type));
					s = n.stepBackward()
				} else s = n.getCurrentToken();
				return a.end.row = n.getCurrentTokenRow(), a.end.column = n.getCurrentTokenColumn() + s.value.length - 2, a
			}
			...
			if (this.$foldStyle != e) {
				"manual" == (this.$foldStyle = e) && this.unfold();
				var t = this.$foldMode;
			...
			else if ("remove" == e.action) this.foldWidgets.splice(t, 1 + i, null);
			else {
				var n = Array(1 + i);
	...
	t.BracketMatch = function () {
		this.findMatchingBracket = function (e, t) {
			...
			if (o[1]) {
				if (!(r = this.$findClosingBracket(o[1], e))) return null;
				t = a.fromPoints(e, r), n || (t.end.column++, t.start.column--), t.cursor = t.end
			} else {
				var r;
				if (!(r = this.$findOpeningBracket(o[2], e))) return null;
				t = a.fromPoints(r, e), n || (t.start.column++, t.end.column--), t.cursor = t.start
			}
			return t
			...
			if (r = r || o.stepForward()) {
				...
				for (var a = t.column - o.getCurrentTokenColumn() - 2, l = r.value; ;) {
					...
					for (;
						(r = o.stepBackward()) && !i.test(r.type););
					if (null == r) break;
	...
	var n = e("./lib/oop"),
		...
		f = function (e, t) {
			this.$breakpoints = [], this.$decorations = [], this.$frontMarkers = {}, this.$backMarkers = {}, this.$markerId = 1, this.$undoSelect = !0, this.$foldData = [], this.id = "session" + ++f.$uid, this.$foldData.toString = function () {
				return this.join("\n")
			}, this.on("changeFold", this.onChangeFold.bind(this)), this.$onChange = this.onChange.bind(this), "object" == typeof e && e.getLine || (e = new u(e)), this.setDocument(e), this.selection = new a(this), this.$bidiHandler = new o(this), r.resetOptions(this), this.setMode(t), r._signal("session", this)
		};
	f.$uid = 0,
		function () {
			function a(e) {
			...
			n.implement(this, l), this.setDocument = function (e) {
				...
				i < t && (this.$docRowCache.splice(i, t), this.$screenRowCache.splice(i, t))
				...
				var i = this.getLine(e),
					n = !1;
				if (0 < t && (n = !!i.charAt(t - 1).match(this.tokenRe)), n = n || !!i.charAt(t).match(this.tokenRe)) var s = this.tokenRe;
				else if (/^\s+$/.test(i.slice(t - 1, t + 1))) s = /\s/;
				else s = this.nonTokenRe;
				var o = t;
				if (0 < o) {
					for (; 0 <= --o && i.charAt(o).match(s););
					o++
				}
				...
				for (var n, s, o = 0; o < e.length; o++) {
					var r = e[o];
					r.start && (n ? i(r) ? (s = r.start, -1 == n.compare(s.row, s.column) && n.setStart(s), s = r.end, 1 == n.compare(s.row, s.column) && n.setEnd(s)) : (s = r.start, -1 == n.compare(s.row, s.column) && (n = c.fromPoints(r.start, r.start))) : n = i(r) ? c.fromPoints(r.start, r.end) : c.fromPoints(r.start, r.start))
				}
				return n
			}, this.replace = function (e, t) {
				...
				if (t = Math.max(0, t), e < 0) t = e = 0;
				else {
					var i = this.doc.getLength();
					t = i <= e ? (e = i - 1, this.doc.getLine(i - 1).length) : Math.min(this.doc.getLine(e).length, t)
				}
				return {
					row: e,
					column: t
				...
				return n != this.$wrapLimit && 1 < n && (this.$wrapLimit = n, this.$modified = !0, this.$useWrapMode && (this.$updateWrapData(0, this.getLength() - 1), this.$resetRowCache(0), this._signal("changeWrapLimit")), !0)
				...
				var r, i, a = this.doc.getAllLines(),
					n = this.getTabSize(),
					s = this.$wrapData,
					o = this.$wrapLimit,
					l = e;
				for (t = Math.min(t, a.length - 1); l <= t;)(i = this.getFoldLine(l, i)) ? (r = [], i.walk(function (e, t, i, n) {
					var s;
					if (null != e) {
						(s = this.$getDisplayTokens(e, r.length))[0] = f;
						for (var o = 1; o < s.length; o++) s[o] = m
					} else s = this.$getDisplayTokens(a[t].substring(n, i), r.length);
					r = r.concat(s)
				}.bind(this), i.end.row, a[i.end.row].length + 1), s[i.start.row] = this.$computeWrapSplits(r, o, n), l = i.end.row + 1) : (r = this.$getDisplayTokens(a[l]), s[l] = this.$computeWrapSplits(r, o, n), l++)
			};
			var f = 3,
				m = 4;
			this.$computeWrapSplits = function (s, e, o) {
				function t(e) {
					...
					r.length || (d = function () {
						...
						return h && !1 !== c && (e += o), Math.min(e, u)
					}(), r.indent = d), l += t, r.push(l), a = e
				}
				...
				for (var r = [], i = s.length, a = 0, l = 0, h = this.$wrapAsCode, c = this.$indentedSoftWrap, u = e <= Math.max(2 * o, 8) || !1 === c ? 0 : Math.floor(e / 2), d = 0; e - d < i - a;) {
					var n = a + e - d;
					if (10 <= s[n - 1] && 10 <= s[n]) t(n);
					else if (s[n] != f && s[n] != m) {
						for (var g = Math.max(n - (e - (e >> 2)), a - 1); g < n && s[n] < f;) n--;
						if (h) {
							for (; g < n && s[n] < f;) n--;
							for (; g < n && 9 == s[n];) n--
						} else
							for (; g < n && s[n] < 10;) n--;
						g < n ? t(++n) : (2 == s[n = a + e] && n--, t(n - d))
					} else {
						for (; n != a - 1 && s[n] != f; n--);
						if (a < n) {
							t(n);
				...
				if (0 == t) return [0, 0];
				var n, s;
				for (null == t && (t = 1 / 0), i = i || 0, s = 0; s < e.length && (9 == (n = e.charCodeAt(s)) ? i += this.getScreenTabSize(i) : 4352 <= n && a(n) ? i += 2 : i += 1, !(t < i)); s++);
				return [i, s]
				...
				for (var g = this.getLength() - 1, f = this.getNextFoldLine(o), m = f ? f.start.row : 1 / 0; a <= e && !(e < a + (l = this.getRowLength(o)) || g <= o);) a += l, m < ++o && (o = f.end.row + 1, m = (f = this.getNextFoldLine(o, f)) ? f.start.row : 1 / 0), d && (this.$docRowCache.push(o), this.$screenRowCache.push(a));
				...
				if (this.$useWrapMode) {
					...
					w && (s = w[v], 0 < v && w.length && (p = w.indent, r = w[v - 1] || w[w.length - 1], n = n.substring(r)))
				}
				return void 0 !== i && this.$bidiHandler.isBidiRow(a + v, o, v) && (t = this.$bidiHandler.offsetToCol(i)), r += this.$getStringScreenWidth(n, t - p)[1], this.$useWrapMode && s <= r && (r = s - 1), f ? f.idxToPosition(r) : {
					row: o,
					column: r
				}
				...
				var f = "";
				o = d && g <= a ? (f = this.getFoldDisplayLine(d, e, t), d.start.row) : (f = this.getLine(e).substring(0, t), e);
				var m = 0;
				if (this.$useWrapMode) {
					var p = this.$wrapData[o];
					if (p) {
						for (var v = 0; f.length >= p[v];) s++, v++;
						f = f.substring(p[v - 1] || 0, f.length), m = 0 < v ? p.indent : 0
					}
				}
				...
				if (this.$useWrapMode)
					for (var i = this.$wrapData.length, n = 0, s = (a = 0, (t = this.$foldData[a++]) ? t.start.row : 1 / 0); n < i;) {
						...
						e += o ? o.length + 1 : 1, s < ++n && (n = t.end.row + 1, s = (t = this.$foldData[a++]) ? t.start.row : 1 / 0)
					} else {
					e = this.getLength();
				...
				this.$enableVarChar && (this.$getStringScreenWidth = function (e, t, i) {
					if (0 === t) return [0, 0];
					var n, s;
					for (t = t || 1 / 0, i = i || 0, s = 0; s < e.length && !(t < (i += "\t" === (n = e.charAt(s)) ? this.getScreenTabSize(i) : o.getCharacterWidth(n))); s++);
					return [i, s]
				})
			}, this.destroy = function () {
	...
	(function () {
		this.set = function (e) {
			...
			return t.forEach(function (e, t, i, n) {
				return o = new y(e, t, i, n), !(t == n && s.start && s.start.start && 0 != s.skipCurrent && o.isEqual(s.start)) || (o = null, !1)
			}), o
			...
			if (t.$isMultiLine) {
				...
				e: for (var h = o.offset || 0; h <= l; h++) {
					for (var c = 0; c < a; c++)
						if (-1 == n[h + c].search(o[c])) continue e;
					var u = n[h],
						d = n[h + a - 1],
						g = u.length - u.match(o[0])[0].length,
						f = d.match(o[a - 1])[0].length;
					r && r.end.row === h && r.end.column > g || (s.push(r = new y(h, g, h + a - 1, f)), 2 < a && (h = h + a - 2))
				}
			} else
				for (var m = 0; m < n.length; m++) {
					var p = b.getMatchOffsets(n[m], o);
					for (c = 0; c < p.length; c++) {
						var v = p[c];
						s.push(new y(m, v.offset, m, v.offset + v.length))
					}
				}
			if (i) {
				var w = i.start.column,
					$ = i.start.column;
				for (m = 0, c = s.length - 1; m < c && s[m].start.column < w && s[m].start.row == i.start.row;) m++;
				for (; m < c && s[c].end.column > $ && s[c].end.row == i.end.row;) c--;
				for (s = s.slice(m, c + 1), m = 0, c = s.length; m < c; m++) s[m].start.row += i.start.row, s[m].end.row += i.start.row
			}
			return s
		}, this.replace = function (e, t) {
			var i = this.$options,
			...
			e.regExp || (s = b.escapeRegExp(s)), e.wholeWord && (n = e, s = o((i = s)[0]) + i + o(i[i.length - 1]));
			var r = e.caseSensitive ? "gm" : "gmi";
			if (e.$isMultiLine = !t && /[\n\r]/.test(s), e.$isMultiLine) return e.re = this.$assembleMultilineRegExp(s, r);
			try {
			...
			var s = t ? t.start.row : 0,
				o = t ? t.end.row : c.getLength() - 1;
			if (l) var r = function (e) {
				var t = n.row;
				if (!a(t, n.column, e)) {
					for (t--; s <= t; t--)
						if (a(t, Number.MAX_VALUE, e)) return;
					if (0 != i.wrap)
						for (t = o, s = n.row; s <= t; t--)
							if (a(t, Number.MAX_VALUE, e)) return
				}
			};
			else r = function (e) {
				...
				if (!a(t, n.column, e)) {
					for (t += 1; t <= o; t++)
						if (a(t, 0, e)) return;
					if (0 != i.wrap)
						for (t = s, o = n.row; t <= o; t++)
							if (a(t, 0, e)) return
				}
			};
			if (i.$isMultiLine) var h = u.length,
				a = function (e, t, i) {
					var n = l ? e - h + 1 : e;
					if (!(n < 0)) {
						var s = c.getLine(n),
						...
						if (!(!l && o < t || -1 === o)) {
							for (var r = 1; r < h; r++)
								if (-1 == (s = c.getLine(n + r)).search(u[r])) return;
							var a = s.match(u[h - 1])[0].length;
							if (!(l && t < a)) return !!i(n, o, n + h - 1, a) || void 0
						}
					}
				};
			else if (l) a = function (e, t, i) {
				var n, s = c.getLine(e),
					o = [],
					r = 0;
				for (u.lastIndex = 0; n = u.exec(s);) {
					...
					if (n.index + a > t) break;
					o.push(n.index, a)
				}
				for (var l = o.length - 1; 0 <= l; l -= 2) {
					var h = o[l - 1];
					if (i(e, h, e, h + (a = o[l]))) return !0
				}
			};
			else a = function (e, t, i) {
				var n, s, o = c.getLine(e);
				for (u.lastIndex = t; s = u.exec(o);) {
					var r = s[0].length;
					if (i(e, n = s.index, e, n + r)) return !0;
					if (!r && (u.lastIndex = n += 1, n >= o.length)) return !1
				}
			};
			return {
				forEach: r
	...
	s.prototype = n.prototype,
		function () {
			...
			this.addCommand = function (e) {
				...
				if ("object" == typeof e && e && (null == r && (r = e.position), e = e[this.platform]), e) return "function" == typeof o ? this.addCommand({
					exec: o,
					bindKey: e,
					name: o.name || e
				...
				if (t)
					if (!s[e] || this.$singleCommand) s[e] = t;
					else {
						Array.isArray(s[e]) ? -1 != (n = s[e].indexOf(t)) && s[e].splice(n, 1) : s[e] = [s[e]], "number" != typeof i && (i = r(t));
						var o = s[e];
				...
				i && Object.keys(i).forEach(function (e) {
					...
					if (t) {
						...
						"function" == typeof t && (t = {
							exec: t
						}), "object" == typeof t && (t.name || (t.name = e), this.addCommand(t))
					}
				}, this)
				...
				var t = e.toLowerCase().split(/[\-\+]([\-\+])?/).filter(function (e) {
					...
					i = t.pop(),
					n = a[i];
				if (a.FUNCTION_KEYS[n]) i = a.FUNCTION_KEYS[n].toLowerCase();
				else {
					if (!t.length) return {
						key: i,
						hashId: -1
				...
				for (var s = 0, o = t.length; o--;) {
					...
					if (null == r) return "undefined" != typeof console && console.error("invalid modifier " + t[o] + " in " + e), !1;
					s |= r
				}
				return {
					key: i,
				...
				if (!(n < 0)) {
					...
					return (e.$keyChain && (e.$keyChain += " " + s, o = this.commandKeyBinding[e.$keyChain] || o), !o || "chainKeys" != o && "chainKeys" != o[o.length - 1]) ? (e.$keyChain && (t && 4 != t || 1 != i.length ? (-1 == t || 0 < n) && (e.$keyChain = "") : e.$keyChain = e.$keyChain.slice(0, -s.length - 1)), {
						command: o
	...
	function n(e, t) {
		o.call(this, t, e), this.byName = this.commands, this.setDefaultHandler("exec", function (e) {
	...
	s.inherits(n, o),
		function () {
			s.implement(this, r), this.exec = function (e, t, i) {
				if (Array.isArray(e)) {
		...
		}.call(n.prototype), t.CommandManager = n
	...
	t.commands = [{
		...
		exec: function (e) {
			...
			n.row + 1 < e.session.doc.getLength() - 1 && (r += e.session.doc.getNewLineCharacter()), e.clearSelection(), e.session.doc.replace(new c(i.row, 0, n.row + 2, 0), r), 0 < o ? (e.selection.moveCursorTo(i.row, i.column), e.selection.selectTo(i.row, i.column + o)) : (s = e.session.doc.getLine(i.row).length > s ? s + 1 : s, e.selection.moveCursorTo(i.row, s))
		},
		multiSelectAction: "forEach",
		readOnly: !0
	}, {
		...
		exec: function (e) {
			...
			for (var o = 0; o < n.length; o++) o != n.length - 1 || n[o].end.row === t && n[o].end.column === i || s.push(new c(n[o].end.row, n[o].end.column, t, i)), 0 === o ? 0 === n[o].start.row && 0 === n[o].start.column || s.push(new c(0, 0, n[o].start.row, n[o].start.column)) : s.push(new c(n[o - 1].end.row, n[o - 1].end.column, n[o].start.row, n[o].start.column));
	...
	var o = e("./lib/oop"),
		...
		b = function (e, t, i) {
			...
			this.container = n, this.renderer = e, this.id = "editor" + ++b.$uid, this.commands = new g(s.isMac ? "mac" : "win", f), "object" == typeof document && (this.textInput = new r(e.getTextAreaContainer(), this), this.renderer.textarea = this.textInput.getElement(), this.$mouseHandler = new a(this), new l(this)), this.keyBinding = new h(this), this.$search = (new u).set({
				wrap: !0
			}), this.$historyTracker = this.$historyTracker.bind(this), this.commands.on("exec", this.$historyTracker), this.$initOperationListeners(), this._$emitInputEvent = p.delayedCall(function () {
			...
			}), this.setSession(t || i && i.session || new c("")), v.resetOptions(this), i && this.setOptions(i), v._signal("editor", this)
		};
	b.$uid = 0,
		function () {
			o.implement(this, d), this.$initOperationListeners = function () {
				this.commands.on("exec", this.startOperation.bind(this), !0), this.commands.on("afterExec", this.endOperation.bind(this), !0), this.$opResetTimer = p.delayedCall(this.endOperation.bind(this, !0)), this.on("change", function () {
				...
				if (this.$mergeUndoDeltas) {
					...
					"always" != this.$mergeUndoDeltas && 2e3 < Date.now() - this.sequenceStartTime && (n = !1), n ? this.session.mergeUndoDeltas = !0 : -1 !== i.indexOf(e.command.name) && (this.sequenceStartTime = Date.now())
				}
			}, this.setKeyboardHandler = function (t, i) {
				if (t && "string" == typeof t && "ace" != t) {
					this.$keybindingId = t;
					var n = this;
					v.loadModule(["keybinding", t], function (e) {
						n.$keybindingId == t && n.keyBinding.setKeyboardHandler(e && e.handler), i && i()
					})
				} else this.$keybindingId = null, this.keyBinding.setKeyboardHandler(t), i && i()
			}, this.getKeyboardHandler = function () {
				...
				if (!this.$highlightPending) {
					...
					this.$highlightPending = !0, setTimeout(function () {
						...
						if (t && t.bgTokenizer) {
							...
							var e = t.getMatchingBracketRanges(n.getCursorPosition());
							if (!e && t.$mode.getMatching && (e = t.$mode.getMatching(n.session)), e) {
								var i = "ace_bracket";
								Array.isArray(e) ? 1 == e.length && (i = "ace_error_bracket") : e = [e], 2 == e.length && (0 == m.comparePoints(e[0].end, e[1].start) ? e = [m.fromPoints(e[0].start, e[1].end)] : 0 == m.comparePoints(e[0].start, e[1].end) && (e = [m.fromPoints(e[1].start, e[0].end)])), t.$bracketHighlight = {
									ranges: e,
									markerIds: e.map(function (e) {
										return t.addMarker(e, i, "text")
									})
								}
							}
						}
				...
				if (!this.$highlightTagPending) {
					...
					this.$highlightTagPending = !0, setTimeout(function () {
						...
						var e = u.session;
						if (e && e.bgTokenizer) {
							var t = u.getCursorPosition(),
								i = new w(u.session, t.row, t.column),
								n = i.getCurrentToken();
							...
							if (-1 == n.type.indexOf("tag-open") || (n = i.stepForward())) {
								var s = n.value,
									...
									r = i.stepBackward();
								if ("<" == r.value)
									for (; r = n, (n = i.stepForward()) && n.value === s && -1 !== n.type.indexOf("tag-name") && ("<" === r.value ? o++ : "</" === r.value && o--), n && 0 <= o;);
								else {
									for (; n = r, r = i.stepBackward(), n && n.value === s && -1 !== n.type.indexOf("tag-name") && ("<" === r.value ? o++ : "</" === r.value && o--), r && o <= 0;);
									i.stepForward()
								}
								if (!n) return e.removeMarker(e.$tagHighlight), void (e.$tagHighlight = null);
								var a = i.getCurrentTokenRow(),
									l = i.getCurrentTokenColumn(),
									h = new m(a, l, a, l + n.value.length),
									c = e.$backMarkers[e.$tagHighlight];
								e.$tagHighlight && null != c && 0 !== h.compareRange(c.range) && (e.removeMarker(e.$tagHighlight), e.$tagHighlight = null), e.$tagHighlight || (e.$tagHighlight = e.addMarker(h, "ace_bracket", "text"))
							}
						}
					}, 50)
				}
				...
				if (this.$highlightActiveLine && ("line" == this.$selectionStyle && this.selection.isMultiLine() || (e = this.getCursorPosition()), this.renderer.theme && this.renderer.theme.$selectionColorConflict && !this.selection.isEmpty() && (e = !1), !this.renderer.$maxLines || 1 !== this.session.getLength() || 1 < this.renderer.$minLines || (e = !1)), t.$highlightLineMarker && !e) t.removeMarker(t.$highlightLineMarker.id), t.$highlightLineMarker = null;
				else if (!t.$highlightLineMarker && e) {
					var i = new m(e.row, e.column, e.row, 1 / 0);
				...
				return this._signal("copy", r), $.lineMode = i ? r.text : "", r.text
				...
				if ("\t" == e && (e = this.session.getTabString()), this.selection.isEmpty()) {
					if (this.session.getOverwrite() && -1 == e.indexOf("\n")) {
						(r = new m.fromPoints(s, s)).end.column += e.length, this.session.remove(r)
					}
				} else {
				...
				if (i.insert(s, e), o && o.selection && (2 == o.selection.length ? this.selection.setSelectionRange(new m(s.row, h + o.selection[0], s.row, h + o.selection[1])) : this.selection.setSelectionRange(new m(s.row + o.selection[0], o.selection[1], s.row + o.selection[2], o.selection[3]))), this.$enableAutoIndent) {
				...
				for (var o, r, a, l = "", h = "", c = "", u = i.getTabString(), d = e; d <= t; d++) 0 < d && (l = i.getState(d - 1), h = i.getLine(d - 1), c = n.getNextLineIndent(l, h, u)), o = i.getLine(d), c !== (r = n.$getIndent(o)) && (0 < r.length && (a = new m(d, 0, d, r.length), i.remove(a)), 0 < c.length && i.insert({
					row: d,
					column: 0
				}, c)), n.autoOutdent(l, i, d)
				...
				var i;
				(t.extendLeft || t.extendRight) && ((i = this.selection.getRange()).start.column -= t.extendLeft, i.end.column += t.extendRight, i.start.column < 0 && (i.start.row--, i.start.column += this.session.getLine(i.start.row).length + 1), this.selection.setRange(i), e || i.isEmpty() || this.remove());
				...
				if (this.selection.isEmpty()) {
					...
					if (0 !== t) {
						...
						n = t < s.length ? (i = s.charAt(t) + s.charAt(t - 1), new m(e.row, t - 1, e.row, t + 1)) : (i = s.charAt(t - 1) + s.charAt(t - 2), new m(e.row, t - 2, e.row, t)), this.session.replace(n, i), this.session.selection.moveToPosition(n.end)
					}
				}
				...
				if (!(t.start.row < t.end.row)) {
					...
					if (this.session.getUseSoftTabs()) var a = o - r % o,
						l = p.stringRepeat(" ", a);
					else {
						for (a = r % o;
							" " == n[t.start.column - 1] && a;) t.start.column--, a--;
				...
				if (!isNaN(parseFloat(s)) && isFinite(s)) {
					...
					if (o) {
						var r = 0 <= o.value.indexOf(".") ? o.start + o.value.indexOf(".") + 1 : o.end,
				...
				n.match(/[A-Za-z0-9_]+/) && t.forEach(function (e, t) {
					a = r + e.length, r <= o && o <= a && (n = e, l.selection.clearSelection(), l.moveCursorTo(i, r + s), l.selection.selectTo(i, a + s)), r = a
				});
				for (var h, c = this.$toggleWordPairs, u = 0; u < c.length; u++)
					for (var d = c[u], g = 0; g <= 1; g++) {
						var f = +!g,
							m = n.match(new RegExp("^\\s?_?(" + p.escapeRegExp(d[g]) + ")\\s?$", "i"));
						if (m) n.match(new RegExp("([_]|^|\\s)(" + p.escapeRegExp(m[1]) + ")($|\\s)", "g")) && (h = n.replace(new RegExp(p.escapeRegExp(d[g]), "i"), function (e) {
							var t = d[f];
							return e.toUpperCase() == e ? t = t.toUpperCase() : e.charAt(0).toUpperCase() == e.charAt(0) && (t = t.substr(0, 0) + d[f].charAt(0).toUpperCase() + t.substr(1)), t
						}), this.insert(h), h = "")
					}
				...
				if (o) {
					...
					if (r) {
						var d, g;
						if ("bracket" === r) (d = this.session.getBracketRange(i)) || (g = (d = new m(n.getCurrentTokenRow(), n.getCurrentTokenColumn() + c - 1, n.getCurrentTokenRow(), n.getCurrentTokenColumn() + c - 1)).start, (t || g.row === i.row && Math.abs(g.column - i.column) < 2) && (d = this.session.getBracketRange(g)));
						else if ("tag" === r) {
							if (!o || -1 === o.type.indexOf("tag-name")) return;
							var f = o.value;
							if (0 === (d = new m(n.getCurrentTokenRow(), n.getCurrentTokenColumn() - 2, n.getCurrentTokenRow(), n.getCurrentTokenColumn() - 2)).compare(i.row, i.column))
								for (l = !1; o = s, (s = n.stepBackward()) && (-1 !== s.type.indexOf("tag-close") && d.setEnd(n.getCurrentTokenRow(), n.getCurrentTokenColumn() + 1), o.value === f && -1 !== o.type.indexOf("tag-name") && ("<" === s.value ? h[f]++ : "</" === s.value && h[f]--, 0 === h[f] && (l = !0))), s && !l;);
							o && o.type.indexOf("tag-name") && ((g = d.start).row == i.row && Math.abs(g.column - i.column) < 2 && (g = d.end))
						} (g = d && d.cursor || g) && (e ? d && t ? this.selection.setRange(d) : d && d.isEqual(this.getSelectionRange()) ? this.clearSelection() : this.selection.selectTo(g.row, g.column) : this.selection.moveTo(g.row, g.column))
					}
				}
				...
				var i = this.$search.find(this.session),
					n = 0;
				return i && (this.$tryReplace(i, e) && (n = 1), this.selection.setSelectionRange(i), this.renderer.scrollSelectionIntoView(i.start, i.end)), n
				...
				for (var o = i.length - 1; 0 <= o; --o) this.$tryReplace(i[o], e) && n++;
				...
				var n = this.selection.getRange();
				null == t.needle && ((e = this.session.getTextRange(n) || this.$search.$options.needle) || (n = this.session.getWordRange(n.start.row, n.start.column), e = this.session.getTextRange(n)), this.$search.set({
					needle: e
				})), this.$search.set(t), t.start || this.$search.set({
					start: n
				});
				var s = this.$search.find(this.session);
				return t.preventScroll ? s : s ? (this.revealRange(s, i), s) : (t.backwards ? n.start = n.end : n.end = n.start, void this.selection.setRange(n))
				...
				if (e) {
					...
					var t = this.on("changeSelection", function () {
						r = !0
					}),
						...
						n = this.renderer.on("afterRender", function () {
							if (r && s && (o.isFocused() || o.searchBox && o.searchBox.isFocused())) {
								var e = o.renderer,
									t = e.$cursorLayer.$pixelPos,
									i = e.layerConfig,
									n = t.top - i.offset;
								null != (r = 0 <= t.top && n + s.top < 0 || !(t.top < i.height && t.top + s.top + i.lineHeight > window.innerHeight) && null) && (a.style.top = n + "px", a.style.left = t.left + "px", a.style.height = i.lineHeight + "px", a.scrollIntoView(r)), r = s = null
							}
						});
					this.setAutoScrollEditorIntoView = function (e) {
						e || (delete this.setAutoScrollEditorIntoView, this.off("changeSelection", t), this.renderer.off("afterRender", n), this.renderer.off("beforeRender", i))
					}
				}
				...
				var s = this;
				v.loadModule("./ext/prompt", function (e) {
					e.prompt(s, t, i, n)
				})
			}
			...
			placeholder: {
				set: function (e) {
					this.$updatePlaceholder || (this.$updatePlaceholder = function () {
						...
						if (e && this.renderer.placeholderNode) this.renderer.off("afterRender", this.$updatePlaceholder), n.removeCssClass(this.container, "ace_hasPlaceholder"), this.renderer.placeholderNode.remove(), this.renderer.placeholderNode = null;
							...
							this.renderer.on("afterRender", this.$updatePlaceholder), n.addCssClass(this.container, "ace_hasPlaceholder");
	...
	function n(e) {
		if (e = e || this, Array.isArray(e)) return e.map(n).join("\n");
		var t = "";
		return e.action ? (t = "insert" == e.action ? "+" : "-", t += "[" + e.lines + "]") : e.value && (t = Array.isArray(e.value) ? e.value.map(s).join("\n") : s(e.value)), e.start && (t += s(e)), (e.id || e.rev) && (t += "\t(" + (e.id || e.rev) + ")"), t
	}
	...
	function o(e, t) {
		var i = "insert" == e.action,
			n = "insert" == t.action;
		if (i && n)
			if (0 <= m(t.start, e.end)) h(t, e, -1);
			else {
				if (!(m(t.start, e.start) <= 0)) return;
				h(e, t, 1)
			}
		else if (i && !n)
			if (0 <= m(t.start, e.end)) h(t, e, -1);
			else {
				if (!(m(t.end, e.start) <= 0)) return;
				h(e, t, -1)
			}
		else if (!i && n)
			if (0 <= m(t.start, e.start)) h(t, e, 1);
			else {
				if (!(m(t.start, e.start) <= 0)) return;
				h(e, t, 1)
			}
	...
	function l(e, t) {
		...
		else if (i && !n) 0 <= m(e.start, t.end) ? h(e, t, -1) : (m(e.start, t.start) <= 0 || h(e, f.fromPoints(t.start, e.start), -1), h(t, e, 1));
		else if (!i && n) 0 <= m(t.start, e.end) ? h(t, e, -1) : (m(t.start, e.start) <= 0 || h(t, f.fromPoints(e.start, t.start), -1), h(e, t, 1));
		else if (!i && !n)
			if (0 <= m(t.start, e.end)) h(t, e, -1);
			else {
				var s, o;
				if (!(m(t.end, e.start) <= 0)) return m(e.start, t.start) < 0 && (e = u(s = e, t.start)), 0 < m(e.end, t.end) && (o = u(e, t.end)), c(t.end, e.start, e.end, -1), o && !s && (e.lines = o.lines, e.start = o.start, e.end = o.end, o = e), [t, s, o].filter(Boolean);
				h(e, t, -1)
			} return [t, e]
	}
	...
	function g() {
		...
		this.addSession = function (e) {
			...
			if (function (e, t) {
				...
				var n = i.pop(),
					s = null;
				return n && (s = e.undoChanges(n, t), this.$redoStack.push(n), this.$syncRev()), this.$fromUndo = !1, s
			}
	...
	(function () {
		this.moveContainer = function (e) {
			...
			if (Array.isArray(e)) {
				...
				for (var t = r.createFragment(this.element), i = 0; i < e.length; i++) t.appendChild(e[i].element);
			...
			if (!s) {
				...
				n && n(o), this.element.appendChild(o), s = {
					element: o,
					text: "",
					row: e
				}
	...
	(function () {
		s.implement(this, o), this.setSession = function (e) {
			...
			for (var t = 0; t < e.length; t++) {
				...
				var o = i.text;
				o = o ? a.escapeHTML(o) : i.html || "", -1 === s.text.indexOf(o) && s.text.push(o);
				var r = i.type;
			...
			if (this.$annotations.length) {
				var t = e.start.row,
					i = e.end.row - t;
				if (0 != i)
					if ("remove" == e.action) this.$annotations.splice(t, 1 + i, null);
					else {
						var n = new Array(1 + i);
			...
			for (var s = t.getNextFoldLine(i), o = s ? s.start.row : 1 / 0, r = null, a = -1, l = i; ;) {
				if (o < l && (l = s.end.row + 1, o = (s = t.getNextFoldLine(l, s)) ? s.start.row : 1 / 0), n < l) {
					...
					for (var i = 0; i < t.length; i++) {
						...
						if (n.row >= this.$cursorRow) {
							if (n.row > this.$cursorRow) {
								...
								if (!(0 < i && s && s.start.row == t[i - 1].row)) break;
								n = t[i - 1]
							}
			...
			if (t.firstRow < e.firstRow)
				for (var s = this.session.getFoldedRowCount(t.firstRow, e.firstRow - 1); 0 < s; s--) this.$lines.shift();
			if (i < n)
				for (s = this.session.getFoldedRowCount(i + 1, n); 0 < s; s--) this.$lines.pop();
			...
			for (var n = [], s = t, o = this.session.getNextFoldLine(s), r = o ? o.start.row : 1 / 0; r < s && (s = o.end.row + 1, r = (o = this.session.getNextFoldLine(s, o)) ? o.start.row : 1 / 0), !(i < s);) {
			...
			var s = e.element,
				...
				h = o.$breakpoints,
				c = o.$decorations,
				u = o.gutterRenderer || this.$renderer,
				d = this.$showFoldWidgets && o.foldWidgets,
				g = i ? i.start.row : Number.MAX_VALUE,
				f = "ace_gutter-cell ";
			if (this.$highlightGutterLine && (n == this.$cursorRow || i && n < this.$cursorRow && g <= n && this.$cursorRow <= i.end.row) && (f += "ace_gutter-active-line ", this.$cursorCell != e && (this.$cursorCell && (this.$cursorCell.element.className = this.$cursorCell.element.className.replace("ace_gutter-active-line ", "")), this.$cursorCell = e)), h[n] && (f += h[n]), c[n] && (f += c[n]), this.$annotations[n] && (f += this.$annotations[n].className), s.className != f && (s.className = f), d) {
				var m = d[n];
				null == m && (m = d[n] = o.getFoldWidget(n))
			}
			if (m) {
				f = "ace_fold-widget ace_" + m;
				"start" == m && n == g && n < i.end.row ? f += " ace_closed" : f += " ace_open", a.className != f && (a.className = f);
				var p = t.lineHeight + "px";
				w.setStyle(a.style, "height", p), w.setStyle(a.style, "display", "inline-block")
			} else a && w.setStyle(a.style, "display", "none");
			var v = (u ? u.getText(o, n) : n + l).toString();
			return v !== r.data && (r.data = v), w.setStyle(e.element.style, "height", this.$lines.computeLineHeight(n, t, o) + "px"), w.setStyle(e.element.style, "top", this.$lines.computeLineTop(n, t, o) + "px"), e.text = v, e
			...
			var e = w.computedStyle(this.element.firstChild);
	...
	(function () {
		this.$padding = 0, this.setPadding = function (e) {
			...
			for (var o = this.session, r = t.start.row, a = t.end.row, l = r, h = 0, c = 0, u = o.getScreenLastRowColumn(l), d = new g(l, t.start.column, l, c); l <= a; l++) d.start.row = d.end.row = l, d.start.column = l == r ? t.start.column : o.getRowWrapIndent(l), h = c, c = d.end.column = u, u = l + 1 < a ? o.getScreenLastRowColumn(l + 1) : l == a ? 0 : t.end.column, this.drawSingleLineMarker(e, d, i + (l == r ? " ace_start" : "") + " ace_br" + ((l == r || l == r + 1 && t.start.column ? 1 : 0) | (h < c ? 2 : 0) | (u < c ? 4 : 0) | (l == a ? 8 : 0)), n, l == a ? 0 : 1, s)
	...
	function n(e) {
		this.dom = h, this.element = this.dom.createElement("div"), this.element.className = "ace_layer ace_text-layer", e.appendChild(this.element), this.$updateEolChar = this.$updateEolChar.bind(this), this.$lines = new o(this.element)
	}
	var s = e("../lib/oop"),
		h = e("../lib/dom"),
		w = e("../lib/lang"),
		...
		r = e("../lib/event_emitter").EventEmitter;
	(function () {
		s.implement(this, r), this.EOF_CHAR = "¶", this.EOL_CHAR_LF = "¬", this.EOL_CHAR_CRLF = "¤", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "—", this.SPACE_CHAR = "·", this.$padding = 0, this.MAX_LINE_LENGTH = 1e4, this.$updateEolChar = function () {
			...
			for (var t = this.$tabStrings = [0], i = 1; i < e + 1; i++)
				if (this.showTabs) {
					(n = this.dom.createElement("span")).className = "ace_invisible ace_invisible_tab", n.textContent = w.stringRepeat(this.TAB_CHAR, i), t.push(n)
				} else t.push(this.dom.createTextNode(w.stringRepeat(" ", i), this.element));
			if (this.displayIndentGuides) {
				this.$indentGuideRe = /\s\S| \t|\t |\s$/;
				var n, s = "ace_indent-guide",
					o = this.showSpaces ? " ace_invisible ace_invisible_space" : "",
					r = this.showSpaces ? w.stringRepeat(this.SPACE_CHAR, this.tabSize) : w.stringRepeat(" ", this.tabSize),
					a = this.showTabs ? " ace_invisible ace_invisible_tab" : "",
					l = this.showTabs ? w.stringRepeat(this.TAB_CHAR, this.tabSize) : r;
				(n = this.dom.createElement("span")).className = s + o, n.textContent = r, this.$tabStrings[" "] = n, (n = this.dom.createElement("span")).className = s + a, n.textContent = l, this.$tabStrings["\t"] = n
			}
			...
			for (var l, h = !1, c = (a = n, (l = this.session.getNextFoldLine(a)) ? l.start.row : 1 / 0); c < a && (a = l.end.row + 1, c = (l = this.session.getNextFoldLine(a, l)) ? l.start.row : 1 / 0), !(s < a);) {
				var u = o[r++];
				if (u) {
			...
			if (t.lastRow > e.lastRow)
				for (s = this.session.getFoldedRowCount(e.lastRow + 1, t.lastRow); 0 < s; s--) this.$lines.pop();
			...
			for (var n = [], s = t, o = this.session.getNextFoldLine(s), r = o ? o.start.row : 1 / 0; r < s && (s = o.end.row + 1, r = (o = this.session.getNextFoldLine(s, o)) ? o.start.row : 1 / 0), !(i < s);) {
				var a = this.$lines.createCell(s, e, this.session),
					l = a.element;
				this.dom.removeChildren(l), h.setStyle(l.style, "height", this.$lines.computeLineHeight(s, e, this.session) + "px"), h.setStyle(l.style, "top", this.$lines.computeLineTop(s, e, this.session) + "px"), this.$renderLine(l, s, s == r && o), this.$useLineGroups() ? l.className = "ace_line_group" : l.className = "ace_line", n.push(a), s++
			}
			return n
		}, this.update = function (e) {
			this.$lines.moveContainer(e);
			...
			for (var s, o = this, r = /(\t)|( +)|([\x00-\x1f\x80-\xa0\xad\u1680\u180E\u2000-\u200f\u2028\u2029\u202F\u205F\uFEFF\uFFF9-\uFFFC]+)|(\u3000)|([\u1100-\u115F\u11A3-\u11A7\u11FA-\u11FF\u2329-\u232A\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3001-\u303E\u3041-\u3096\u3099-\u30FF\u3105-\u312D\u3131-\u318E\u3190-\u31BA\u31C0-\u31E3\u31F0-\u321E\u3220-\u3247\u3250-\u32FE\u3300-\u4DBF\u4E00-\uA48C\uA490-\uA4C6\uA960-\uA97C\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFAFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFF01-\uFF60\uFFE0-\uFFE6]|[\uD800-\uDBFF][\uDC00-\uDFFF])/g, a = this.dom.createFragment(this.element), l = 0; s = r.exec(n);) {
				var h = s[1],
					c = s[2],
					u = s[3],
					d = s[4],
					g = s[5];
				if (o.showSpaces || !c) {
					var f = l != s.index ? n.slice(l, s.index) : "";
					if (l = s.index + s[0].length, f && a.appendChild(this.dom.createTextNode(f, this.element)), h) {
						var m = o.session.getScreenTabSize(t + s.index);
						a.appendChild(o.$tabStrings[m].cloneNode(!0)), t += m - 1
					} else if (c)
						if (o.showSpaces) {
							(v = this.dom.createElement("span")).className = "ace_invisible ace_invisible_space", v.textContent = w.stringRepeat(o.SPACE_CHAR, c.length), a.appendChild(v)
						} else a.appendChild(this.com.createTextNode(c, this.element));
					else if (u) {
						(v = this.dom.createElement("span")).className = "ace_invisible ace_invisible_space ace_invalid", v.textContent = w.stringRepeat(o.SPACE_CHAR, u.length), a.appendChild(v)
					} else if (d) {
						t += 1, (v = this.dom.createElement("span")).style.width = 2 * o.config.characterWidth + "px", v.className = o.showSpaces ? "ace_cjk ace_invisible ace_invisible_space" : "ace_cjk", v.textContent = o.showSpaces ? o.SPACE_CHAR : d, a.appendChild(v)
					} else if (g) {
						t += 1, (v = this.dom.createElement("span")).style.width = 2 * o.config.characterWidth + "px", v.className = "ace_cjk", v.textContent = g, a.appendChild(v)
					}
				}
			}
			if (a.appendChild(this.dom.createTextNode(l ? n.slice(l) : n, this.element)), this.$textToken[i.type]) e.appendChild(a);
			else {
				var p = "ace_" + i.type.replace(/\./g, " ace_"),
					v = this.dom.createElement("span");
				"fold" == i.type && (v.style.width = i.value.length * this.config.characterWidth + "px"), v.className = p, v.appendChild(a), e.appendChild(v)
			}
			return t + n.length
			...
			for (var l = 0; l < t.length; l++) {
				...
				if (0 == l && this.displayIndentGuides) {
					if (n = c.length, !(c = this.renderIndentGuide(a, c, o))) continue;
					n -= c.length
				}
				if (n + c.length < o) r = this.$renderToken(a, r, h, c), n += c.length;
				else {
					for (; n + c.length >= o;) r = this.$renderToken(a, r, h, c.substring(0, o - n)), c = c.substring(o - n), n = o, a = this.$createLineElement(), e.appendChild(a), a.appendChild(this.dom.createTextNode(w.stringRepeat(" ", i.indent), this.element)), r = 0, o = i[++s] || Number.MAX_VALUE;
					0 != c.length && (n += c.length, r = this.$renderToken(a, r, h, c))
				}
			}
			...
			return t.walk(function (e, t, i, n, s) {
				null != e ? r.push({
					type: "fold",
					value: e
				}) : (s && (a = o.getTokens(t)), a.length && function (e, t, i) {
					for (var n = 0, s = 0; s + e[n].value.length < t;)
						if (s += e[n].value.length, ++n == e.length) return;
					for (s != t && ((o = e[n].value.substring(t - s)).length > i - t && (o = o.substring(0, i - t)), r.push({
						type: e[n].type,
						value: o
					}), s = t + o.length, n += 1); s < i && n < e.length;) {
						var o;
						(o = e[n].value).length + s > i ? r.push({
							type: e[n].type,
							value: o.substring(0, i - s)
						}) : r.push(e[n]), s += o.length, n += 1
					}
				}(a, n, i))
	...
	function n(e) {
		this.element = h.createElement("div"), this.element.className = "ace_layer ace_cursor-layer", e.appendChild(this.element), this.isVisible = !1, this.isBlinking = !0, this.blinkInterval = 1e3, this.smoothBlinking = !1, this.cursors = [], this.cursor = this.addCursor(), h.addCssClass(this.element, "ace_hidden-cursors"), this.$updateCursors = this.$updateOpacity.bind(this)
	}
	var h = e("../lib/dom");
	(function () {
		this.$updateOpacity = function (e) {
			for (var t = this.cursors, i = t.length; i--;) h.setStyle(t[i].style, "opacity", e ? "" : "0")
			...
			e != this.smoothBlinking && (this.smoothBlinking = e, h.setCssClass(this.element, "ace_smooth-blinking", e), this.$updateCursors(!0), this.restartTimer())
			...
			this.isVisible = !1, h.addCssClass(this.element, "ace_hidden-cursors"), this.restartTimer()
		}, this.showCursor = function () {
			this.isVisible = !0, h.removeCssClass(this.element, "ace_hidden-cursors"), this.restartTimer()
		}, this.restartTimer = function () {
			var e = this.$updateCursors;
			if (clearInterval(this.intervalId), clearTimeout(this.timeoutId), this.$stopCssAnimation(), this.smoothBlinking && h.removeCssClass(this.element, "ace_smooth-blinking"), e(!0), this.isBlinking && this.blinkInterval && this.isVisible)
				if (this.smoothBlinking && setTimeout(function () {
					h.addCssClass(this.element, "ace_smooth-blinking")
				}.bind(this)), h.HAS_CSS_ANIMATION) this.$startCssAnimation();
				else {
					var t = function () {
			...
			for (var s = t.length; i < s; i++) {
				...
				if (!((o.top > e.height + e.offset || o.top < 0) && 1 < i)) {
					var r = this.cursors[n++] || this.addCursor(),
						a = r.style;
					this.drawCursor ? this.drawCursor(r, o, e, t[i], this.session) : this.isCursorInView(o, e) ? (h.setStyle(a, "display", "block"), h.translate(r, o.left, o.top), h.setStyle(a, "width", Math.round(e.characterWidth) + "px"), h.setStyle(a, "height", e.lineHeight + "px")) : h.setStyle(a, "display", "none")
				}
			}
	...
	(function () {
		s.implement(this, a), this.setVisible = function (e) {
	...
	function n(e, t) {
		...
		this._flush = function (e) {
			i.pending = !1;
			var t = i.changes;
			if (t && (s.blockIdle(100), i.changes = 0, i.onRender(t)), i.changes) {
	...
	(function () {
		this.schedule = function (e) {
			this.changes = this.changes | e, this.changes && !this.pending && (s.nextFrame(this._flush), this.pending = !0)
	...
	(function () {
		n.implement(this, l), this.$characterSize = {
			...
			return this.$pollSizeChangesTimer = r.onIdle(function e() {
				t.checkForSizeChanges(), r.onIdle(e, 500)
			}, 500)
			...
			if (t) {
				var f = t,
					m = u[0] * f[0] / 200 + u[1] * f[1] / 200 + 1,
					p = s(o(f[0], d), o(f[1], g));
				return s(o(1 / m / 200, p), a)
			}
			var v = n(e, a),
				w = i(n(d, o(u[0], v)), n(g, o(u[1], v)), v);
			return o(200, w)
		}
	}).call(c.prototype)
	...
	function w(e, t) {
		var i = this;
		this.container = e || c.createElement("div"), c.addCssClass(this.container, "ace_editor"), c.HI_DPI && c.addCssClass(this.container, "ace_hidpi"), this.setTheme(t), this.$gutter = c.createElement("div"), this.$gutter.className = "ace_gutter", this.container.appendChild(this.$gutter), this.$gutter.setAttribute("aria-hidden", !0), this.scroller = c.createElement("div"), this.scroller.className = "ace_scroller", this.container.appendChild(this.scroller), this.content = c.createElement("div"), this.content.className = "ace_content", this.scroller.appendChild(this.content), this.$gutterLayer = new s(this.$gutter), this.$gutterLayer.on("changeGutterWidth", this.onGutterResize.bind(this)), this.$markerBack = new r(this.content);
		var n = this.$textLayer = new a(this.content);
		this.canvas = n.element, this.$markerFront = new r(this.content), this.$cursorLayer = new l(this.content), this.$horizScroll = !1, this.$vScroll = !1, this.scrollBar = this.scrollBarV = new u(this.container, this), this.scrollBarH = new h(this.container, this), this.scrollBarV.on("scroll", function (e) {
			...
			v: 0,
			h: 0
		}, this.$keepTextAreaAtCursor = !p.isIOS, this.$loop = new d(this.$renderChanges.bind(this), this.container.ownerDocument.defaultView), this.$loop.schedule(this.CHANGE_FULL), this.updateCharacterSize(), this.setPadding(4), o.resetOptions(this), o._signal("renderer", this)
	} (function () {
		this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, n.implement(this, f), this.updateCharacterSize = function () {
			...
			if (n && (e || o.height != n) && (o.height = n, s |= this.CHANGE_SIZE, o.scrollerHeight = o.height, this.$horizScroll && (o.scrollerHeight -= this.scrollBarH.getHeight()), this.scrollBarV.element.style.bottom = this.scrollBarH.getHeight() + "px", s |= this.CHANGE_SCROLL), i && (e || o.width != i)) {
				s |= this.CHANGE_SIZE, o.width = i, null == t && (t = this.$showGutter ? this.$gutter.offsetWidth : 0), this.gutterWidth = t, c.setStyle(this.scrollBarH.element.style, "left", t + "px"), c.setStyle(this.scroller.style, "left", t + this.margin.left + "px"), o.scrollerWidth = Math.max(0, i - t - this.scrollBarV.getWidth() - this.margin.h), c.setStyle(this.$gutter.style, "left", this.margin.left + "px");
				var a = this.scrollBarV.getWidth() + "px";
				c.setStyle(this.scrollBarH.element.style, "right", a), c.setStyle(this.scroller.style, "right", a), c.setStyle(this.scroller.style, "bottom", this.scrollBarH.getHeight()), (this.session && this.session.getUseWrapMode() && this.adjustWrapLimit() || e) && (s |= this.CHANGE_FULL)
			}
			return o.$dirty = !i || !n, s && this._signal("resize", r), s
			...
			if (this.$showPrintMargin || this.$printMarginEl) {
				if (!this.$printMarginEl) {
					...
					e.className = "ace_layer ace_print-margin-layer", this.$printMarginEl = c.createElement("div"), this.$printMarginEl.className = "ace_print-margin", e.appendChild(this.$printMarginEl), this.content.insertBefore(e, this.content.firstChild)
				}
				...
				if (this.$keepTextAreaAtCursor || t) {
					...
					if (i) {
						...
						var n = this.layerConfig,
							...
							o = i.left;
						s -= n.offset;
						var r = t && t.useTextareaForIME ? this.lineHeight : v ? 0 : 1;
						if (s < 0 || s > n.height - r) c.translate(this.textarea, 0, 0);
						else {
							var a = 1,
								l = this.$size.height - r;
							if (t)
								if (t.useTextareaForIME) {
									var h = this.textarea.value;
									a = this.characterWidth * this.session.$getStringScreenWidth(h)[0]
								} else s += this.lineHeight + 2;
							else s += this.lineHeight;
							(o -= this.scrollLeft) > this.$size.scrollerWidth - a && (o = this.$size.scrollerWidth - a), o += this.gutterWidth + this.margin.left, c.setStyle(e, "height", r + "px"), c.setStyle(e, "width", a + "px"), c.translate(this.textarea, Math.min(o, this.$size.scrollerWidth - a), Math.min(s, l))
						}
					}
				} else c.translate(this.textarea, -100, 0)
			}
		}, this.getFirstVisibleRow = function () {
			...
			if (this.$changes && (e |= this.$changes, this.$changes = 0), this.session && this.container.offsetWidth && !this.$frozen && (e || t)) {
				...
				if (e & this.CHANGE_FULL || e & this.CHANGE_SIZE || e & this.CHANGE_TEXT || e & this.CHANGE_LINES || e & this.CHANGE_SCROLL || e & this.CHANGE_H_SCROLL) {
					if (e |= this.$computeLayerConfig() | this.$loop.clear(), i.firstRow != this.layerConfig.firstRow && i.firstRowScreen == this.layerConfig.firstRowScreen) {
						...
						0 < n && (this.scrollTop = n, e |= this.CHANGE_SCROLL, e |= this.$computeLayerConfig() | this.$loop.clear())
					}
					i = this.layerConfig, this.$updateScrollBarV(), e & this.CHANGE_H_SCROLL && this.$updateScrollBarH(), c.translate(this.content, -this.scrollLeft, -i.offset);
					var s = i.width + 2 * this.$padding + "px",
						o = i.minHeight + "px";
					c.setStyle(this.content.style, "width", s), c.setStyle(this.content.style, "height", o)
				}
			...
			var g, f, m = this.scrollTop % this.lineHeight,
				p = Math.ceil(l / this.lineHeight) - 1,
				v = Math.max(0, Math.round((this.scrollTop - m) / this.lineHeight)),
				w = v + p,
				$ = this.lineHeight;
			...
			if (0 !== this.$size.scrollerHeight) {
				...
				o < l + r ? (t && l + r > o + this.lineHeight && (o -= t * this.$size.scrollerHeight), 0 === o && (o = -this.scrollMargin.top), this.session.setScrollTop(o)) : l + this.$size.scrollerHeight - a < o + this.lineHeight && (t && l + this.$size.scrollerHeight - a < o - this.lineHeight && (o += t * this.$size.scrollerHeight), this.session.setScrollTop(o + this.lineHeight + a - this.$size.scrollerHeight));
				var h = this.scrollLeft;
				s < h ? (s < this.$padding + 2 * this.layerConfig.characterWidth && (s = -this.scrollMargin.left), this.session.setScrollLeft(s)) : h + this.$size.scrollerWidth < s + this.characterWidth ? this.session.setScrollLeft(Math.round(s + this.characterWidth - this.$size.scrollerWidth)) : h <= this.$padding && s - h < this.characterWidth && this.session.setScrollLeft(0)
			}
		}, this.getScrollTop = function () {
			...
			var i, n, s = 0,
				o = this.STEPS,
				r = [];
			for (s = 0; s < o; ++s) r.push((i = s / this.STEPS, (t - (n = e)) * (Math.pow(i - 1, 3) + 1) + n));
			return r
		}, this.scrollToLine = function (e, t, i, n) {
			...
			if (this.$composition) {
				this.$composition.markerId && this.session.removeMarker(this.$composition.markerId), c.removeCssClass(this.textarea, "ace_composition"), this.textarea.style.cssText = this.$composition.cssText;
			...
			function e(e) {
				if (s.$themeId != i) return n && n();
				if (!e || !e.cssClass) throw new Error("couldn't load module " + i + " or it didn't call define");
				e.$id && (s.$themeId = e.$id), c.importCssString(e.cssText, e.cssClass, s.container), s.theme && c.removeCssClass(s.container, s.theme.cssClass);
				var t = "padding" in e ? e.padding : "padding" in (s.theme || {}) ? 4 : s.$padding;
				s.$padding && t != s.$padding && s.setPadding(t), s.$theme = e.cssClass, s.theme = e, c.addCssClass(s.container, e.cssClass), c.setCssClass(s.container, "ace_dark", e.isDark), s.$size && (s.$size.width = 0, s.$updateSizeAsync()), s._dispatchEvent("themeLoaded", {
					theme: e
				}), n && n()
			}
			var s = this;
			if (this.$themeId = i, s._dispatchEvent("themeChange", {
				theme: i
			}), i && "string" != typeof i) e(i);
			else {
				var t = i || this.$options.theme.initialValue;
	...
	var i = a("../lib/oop"),
		...
		u = a("../config");
	(function () {
		i.implement(this, c), this.$createWorkerFromOldConfig = function (e, t, i, n, s) {
			if (a.nameToUrl && !a.toUrl && (a.toUrl = a.nameToUrl), u.get("packaged") || !a.toUrl) n = n || u.moduleUrl(t, "worker");
			else {
			...
			return this.$worker = l(n), s && this.send("importScripts", s), this.$worker.postMessage({
				init: !0,
				tlns: r,
				module: t,
				classname: i
	...
	e.UIWorkerClient = function (e, t, i) {
		...
		return o.postMessage = function (e) {
			...
			for (n = new e[i](o); r.length;) l()
		}), a
	}, e.WorkerClient = h, e.createWorker = l
	...
	(function () {
		o.implement(this, s), this.setup = function () {
			var i = this,
				n = this.doc,
				e = this.session;
			this.selectionBefore = e.selection.toJSON(), e.selection.inMultiSelectMode && e.selection.toSingleRange(), this.pos = n.createAnchor(this.$pos.row, this.$pos.column);
			var t = this.pos;
			t.$insertRight = !0, t.detach(), t.markerId = e.addMarker(new l(t.row, t.column, t.row, t.column + this.length), this.mainClass, null, !1), this.others = [], this.$others.forEach(function (e) {
				var t = n.createAnchor(e.row, e.column);
				t.$insertRight = !0, t.detach(), i.others.push(t)
			}), e.setUndoSelect(!1)
			...
			if (t.start.row === t.end.row && t.start.row === this.pos.row) {
				...
				if (this.updateAnchors(e), n && (this.length += i), n && !this.session.$fromUndo)
					if ("insert" === e.action)
	...
	t.onMouseDown = function (e) {
		var t = e.domEvent,
			...
			o = e.getAccelKey(),
			r = e.getButton();
		if (s && R.isMac && (r = t.button), e.editor.inMultiSelectMode && 2 == r) e.editor.textInput.onContextMenu(e.domEvent);
		else if (s || i || o) {
			if (0 === r) {
				var a, l = e.editor,
					h = l.selection,
					...
					d = h.getCursor(),
					g = e.inSelection() || h.isEmpty() && k(u, d),
					f = e.x,
					m = e.y,
					p = l.session,
					v = l.renderer.pixelToScreenCoordinates(f, m),
					w = v;
				if (l.$mouseHandler.$enableJumpToDef) s && i || o && i ? a = n ? "block" : "add" : i && l.$blockSelectEnabled && (a = "block");
				else if (o && !i) {
					if (a = "add", !c && n) return
				} else i && l.$blockSelectEnabled && (a = "block");
				if (a && R.isMac && t.ctrlKey && l.$mouseHandler.cancelContextMenu(), "add" == a) {
					if (!c && g) return;
					if (!c) {
						var $ = h.toOrientedRange();
						l.addSelectionMarker($)
					}
					var b = h.rangeList.rangeAtPoint(u);
					l.inVirtualSelectionMode = !0, n && (b = null, $ = h.ranges[0] || $, l.removeSelectionMarker($)), l.once("mouseup", function () {
						var e = h.toOrientedRange();
						b && e.isEmpty() && k(b.cursor, e.cursor) ? h.substractPoint(e.cursor) : (n ? h.substractPoint($.cursor) : $ && (l.removeSelectionMarker($), h.addRange($)), h.addRange(e)), l.inVirtualSelectionMode = !1
					})
				} else if ("block" == a) {
					...
					function y() {
						var e = l.renderer.pixelToScreenCoordinates(f, m),
							t = p.screenToDocumentPosition(e.row, e.column, e.offsetX);
						k(w, e) && k(t, h.lead) || (w = e, l.selection.moveToPosition(t), l.renderer.scrollCursorIntoView(), l.removeSelectionMarkers(C), C = h.rectangularRangeBlock(w, v), l.$mouseHandler.$clickSelection && 1 == C.length && C[0].isEmpty() && (C[0] = l.$mouseHandler.$clickSelection.clone()), C.forEach(l.addSelectionMarker, l), l.updateSelectionMarkers())
					}
					var S, C = [];
					c && !o ? h.toSingleRange() : !c && o && (S = h.toOrientedRange(), l.addSelectionMarker(S)), n ? v = p.documentToScreenPosition(h.lead) : h.moveToPosition(u), w = {
						row: -1,
						column: -1
					};
					var x = y;
					L.capture(l.container, function (e) {
						f = e.clientX, m = e.clientY
					}, function (e) {
						y(), clearInterval(A), l.removeSelectionMarkers(C), C.length || (C = [h.toOrientedRange()]), S && (l.removeSelectionMarker(S), h.toSingleRange(S));
						for (var t = 0; t < C.length; t++) h.addRange(C[t]);
		...
		} else 0 === r && e.editor.inMultiSelectMode && e.editor.exitMultiSelectMode()
	}
	...
	function n(e) {
		e.$multiselectOnSessionChange || (e.$onAddRange = e.$onAddRange.bind(e), e.$onRemoveRange = e.$onRemoveRange.bind(e), e.$onMultiSelect = e.$onMultiSelect.bind(e), e.$onSingleSelect = e.$onSingleSelect.bind(e), e.$multiselectOnSessionChange = t.onSessionChange.bind(e), e.$checkMultiselectChange = e.$checkMultiselectChange.bind(e), e.$multiselectOnSessionChange(e), e.on("changeSession", e.$multiselectOnSessionChange), e.on("mousedown", o), e.commands.addCommands(a.defaultCommands), function (i) {
			function n(e) {
				s && (i.renderer.setMouseCursor(""), s = !1)
			}
			if (!i.textInput) return;
			var e = i.textInput.getElement(),
				s = !1;
			r.addListener(e, "keydown", function (e) {
				var t = 18 == e.keyCode && !(e.ctrlKey || e.shiftKey || e.metaKey);
				i.$blockSelectEnabled && t ? s || (i.renderer.setMouseCursor("crosshair"), s = !0) : s && n()
			}, i), r.addListener(e, "keyup", n, i), r.addListener(e, "blur", n, i)
		}(e))
	}
	var s = e("./range_list").RangeList,
		b = e("./range").Range,
			...
			this.ranges = null, this.rangeList = null, this.addRange = function (e, t) {
				...
				for (var e = this.ranges.length ? this.ranges : [this.getRange()], t = [], i = 0; i < e.length; i++) {
					...
					if (s === o) t.push(n.clone());
						...
						for (t.push(new b(s, n.start.column, s, this.session.getLine(s).length)); ++s < o;) t.push(this.getLineRange(s, !0));
				...
				if (s) var o = e.column,
					...
					a = e.offsetX,
					l = t.offsetX;
				else o = t.column, r = e.column, a = t.offsetX, l = e.offsetX;
				...
				for (var m = g; m <= f; m++) {
					var p = b.fromPoints(this.session.screenToDocumentPosition(m, o, a), this.session.screenToDocumentPosition(m, r, l));
					if (p.isEmpty()) {
						if (h && (c = p.end, u = h, c.row == u.row && c.column == u.column)) break;
						h = p.end
					}
					p.cursor = s ? p.start : p.end, n.push(p)
				}
				if (d && n.reverse(), !i) {
					for (var v = n.length - 1; n[v].isEmpty() && 0 < v;) v--;
					if (0 < v)
						for (var w = 0; n[w].isEmpty();) w++;
					for (var $ = v; w <= $; $--) n[$].isEmpty() && n.splice($, 1)
				}
				return n
			}
		}.call(m.prototype);
	...
	(function () {
		this.updateSelectionMarkers = function () {
			...
			var t = e.command,
				i = e.editor;
			if (i.multiSelect) {
				if (t.multiSelectAction) n = "forEach" == t.multiSelectAction ? i.forEachSelection(t, e.args) : "forEachLine" == t.multiSelectAction ? i.forEachSelection(t, e.args, !0) : "single" == t.multiSelectAction ? (i.exitMultiSelectMode(), t.exec(i, e.args || {})) : t.multiSelectAction(i, e.args || {});
				else {
			...
			if (!this.inVirtualSelectionMode) {
				...
				for (var d = h.length; d--;) {
					if (o)
						for (; 0 < d && h[d].start.row == h[d - 1].end.row;) d--;
					u.fromOrientedRange(h[d]), u.index = d, this.selection = r.selection = u;
					var g = e.exec ? e.exec(this, t || {}) : e(this, t || {});
					n || void 0 === g || (n = g), u.toOrientedRange(h[d])
				}
				u.detach(), this.selection = r.selection = a, this.inVirtualSelectionMode = !1, a._eventRegistry = c, a.mergeOverlappingRanges(), a.ranges[0] && a.fromOrientedRange(a.ranges[0]);
			...
			var o, r = this.session.screenToDocumentPosition(s.row + e, s.column);
			if (i.isEmpty()) l = r;
			else var a = this.session.documentToScreenPosition(n ? i.end : i.start),
				l = this.session.screenToDocumentPosition(a.row + e, a.column);
			n ? (o = b.fromPoints(r, l)).cursor = o.start : (o = b.fromPoints(l, r)).cursor = o.end;
			...
			if (!s.isEmpty() || ((s = n.getWordRange(s.start.row, s.start.column)).cursor = -1 == e ? s.start : s.end, this.multiSelect.addRange(s), !i)) {
				var o, r, a, l = n.getTextRange(s),
					h = (o = n, r = l, a = e, c.$options.wrap = !0, c.$options.needle = r, c.$options.backwards = -1 == a, c.find(o));
				h && (h.cursor = -1 == e ? h.start : h.end, this.session.unfold(h), this.multiSelect.addRange(h), this.renderer.scrollCursorIntoView(null, .5)), t && this.multiSelect.substractPoint(s.cursor)
			}
			...
			if (e.length && n.length != e.length - 1) {
				...
				var r = 0,
					...
					l = e.map(function (e) {
						...
						return -1 == i && (i = 0), t.column > r && (r = t.column), i < a && (a = i), i
					});
				e.forEach(function (e, t) {
					var i = e.cursor,
						n = r - i.column,
						s = l[t] - a;
					s < n ? o.insert(i, p.stringRepeat(" ", n - s)) : o.remove(new b(i.row, i.column, i.row, i.column - n + s)), e.start.column = e.end.column = r, e.start.row = e.end.row = i.row, e.cursor = e.end
				...
				var s = this.selection.getRange(),
					...
					u = h == c;
				if (u) {
					for (var d, g = this.session.getLength(); d = this.session.getLine(c), /[=:]/.test(d) && ++c < g;);
					for (; d = this.session.getLine(h), /[=:]/.test(d) && 0 < --h;);
					h < 0 && (h = 0), g <= c && (c = g - 1)
				}
				var f = this.session.removeFullLines(h, c);
				f = this.$reAlignText(f, u), this.session.insert({
					row: h,
					column: 0
				}, f.join("\n") + "\n"), u || (s.start.column = 0, s.end.column = f[f.length - 1].length), this.selection.setRange(s)
			}
			...
			return e.map(function (e) {
				var t = e.match(/(\s*)(.*?)(\s*)([=:].*)/);
				return t ? (null == s ? (s = t[1].length, o = t[2].length, r = t[3].length) : (s + o + r != t[1].length + t[2].length + t[3].length && (l = !1), s != t[1].length && (a = !1), s > t[1].length && (s = t[1].length), o < t[2].length && (o = t[2].length), r > t[3].length && (r = t[3].length)), t) : [e]
		...
		enableMultiselect: {
			set: function (e) {
				n(this), e ? (this.on("changeSession", this.$multiselectOnSessionChange), this.on("mousedown", o)) : (this.off("changeSession", this.$multiselectOnSessionChange), this.off("mousedown", o))
			},
			value: !0
		},
		enableBlockSelect: {
	...
	(function () {
		this.foldingStartMarker = null, this.foldingStopMarker = null, this.getFoldWidget = function (e, t, i) {
			...
			if (r) {
				...
				return null == a && (a = e.getFoldWidget(r.row)), "start" == a && r.row > o.row && (r.row--, r.column = e.getLine(r.row).length), g.fromPoints(o, r)
			}
			...
			if (r) return r.column++, o.column--, g.fromPoints(r, o)
		}
	}).call(n.prototype)
	...
	(function () {
		this.getRowLength = function (e) {
			...
			if (e) {
				...
				e.forEach(function (e, t) {
					if (e)
						for (i = !1, e.row = t; e.$oldWidget;) e.$oldWidget.row = t, e = e.$oldWidget
			...
			if (n) {
				for (var s = Math.min(this.firstRow, i.firstRow), o = Math.max(this.lastRow, i.lastRow, n.length); 0 < s && !n[s];) s--;
	...
	function f(e, t, i) {
		...
		if (n.length) {
			...
			s < 0 && (s = -s - 1), s >= n.length ? s = 0 < i ? 0 : n.length - 1 : 0 === s && i < 0 && (s = n.length - 1);
			var o = n[s];
			if (o && i) {
				if (o.row === t) {
					for (;
				...
				var r = [];
				for (t = o.row; r[i < 0 ? "unshift" : "push"](o), (o = n[s += i]) && o.row == t;);
				return r.length && r
			}
		}
	}
	...
	t.showErrorMarker = function (e, t) {
		var i = e.session;
		i.widgetManager || (i.widgetManager = new m(i), i.widgetManager.attach(e));
		var n = e.getCursorPosition(),
			s = n.row,
		...
		if (a) {
			var l = a[0];
			n.column = (l.pos && "number" != typeof l.column ? l.pos.sc : l.column) || 0, n.row = l.row, r = e.renderer.$gutterLayer.$annotations[n.row]
		} else {
			if (o) return;
			r = {
				text: ["Looks good!"],
		...
		u.style.left = d + e.renderer.gutterWidth - 5 + "px", h.el.className = "error_widget_wrapper", c.className = "error_widget " + r.className, c.innerHTML = r.text.join("<br>"), c.appendChild(p.createElement("div"));

		function g(e, t, i) {
			if (0 === t && ("esc" === i || "return" === i)) return h.destroy(), {
				command: "null"
			}
		}
		h.destroy = function () {
			e.$mouseHandler.isMousePressed || (e.keyBinding.removeKeyboardHandler(g), i.widgetManager.removeLineWidget(h), e.off("changeSelection", h.destroy), e.off("changeSession", h.destroy), e.off("mouseup", h.destroy), e.off("change", h.destroy))
	...
	e("./worker/worker_client"), e("./keyboard/hash_handler"), e("./placeholder"), e("./multi_select"), e("./mode/folding/fold_mode"), e("./theme/textmate"), e("./ext/error_marker"), l.config = e("./config"), l.require = e, "function" == typeof define && (l.define = define), l.edit = function (e, t) {
		if ("string" == typeof e) {
			var i = e;
			if (!(e = document.getElementById(i))) throw new Error("ace.edit can't find div #" + i)
		}
		if (e && e.env && e.env.editor instanceof u) return e.env.editor;
		var n = "";
		if (e && /input|textarea/i.test(e.tagName)) {
			var s = e;
			n = s.value, e = h.createElement("pre"), s.parentNode.replaceChild(e, s)
		} else e && (n = e.textContent, e.innerHTML = "");
		var o = l.createEditSession(n),
			r = new u(new d(e), o, t),
			a = {
				document: o,
				editor: r,
		...
		return s && (a.textarea = s), c.addListener(window, "resize", a.onResize), r.on("destroy", function () {
			c.removeListener(window, "resize", a.onResize), a.editor.container.env = null
		}), r.container.env = r.env = a, r
	}, l.createEditSession = function (e, t) {
		var i = new n(e, t);
		return i.setUndoManager(new s), i
	}, l.Range = i, l.Editor = u, l.EditSession = n, l.UndoManager = s, l.VirtualRenderer = d, l.version = l.config.version
}), window.require(["ace/ace"], function (e) {
	for (var t in e && (e.config.init(!0), e.define = window.define), window.ace || (window.ace = e), e) e.hasOwnProperty(t) && (window.ace[t] = e[t]);
